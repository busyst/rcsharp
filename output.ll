...
@.str.2 = private unnamed_addr constant [14 x i8] c"MyWindowClass\00"
@.str.3 = private unnamed_addr constant [46 x i8] c"Window error: StartError::RegisterClassFailed\00"
@.str.4 = private unnamed_addr constant [14 x i8] c"Hello, World!\00"
...
@.str.7 = private unnamed_addr constant [3 x i8] c"0\0A\00"
@.str.8 = private unnamed_addr constant [26 x i8] c"stdout handle was invalid\00"
...
@.str.23 = private unnamed_addr alias [1 x i8], [1 x i8]* bitcast (i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.0, i64 0, i64 17) to [1 x i8]*)
...
@.str.42 = private unnamed_addr constant [15 x i8] c"process_test: \00"
@.str.43 = private unnamed_addr constant [49 x i8] c"process_test: get_executable_path returned empty\00"
@.str.44 = private unnamed_addr constant [53 x i8] c"process_test: get_executable_env_path returned empty\00"
@.str.45 = private unnamed_addr constant [53 x i8] c"process_test: env path is not shorter than full path\00"
@.str.46 = private unnamed_addr constant [53 x i8] c"process_test: env path does not end with a backslash\00"
@.str.47 = private unnamed_addr constant [18 x i8] c"Executable Path: \00"
@.str.48 = private unnamed_addr constant [19 x i8] c"Environment Path: \00"
@.str.49 = private unnamed_addr constant [11 x i8] c"mem_test: \00"
@.str.50 = private unnamed_addr constant [24 x i8] c"mem_test: malloc failed\00"
@.str.51 = private unnamed_addr constant [35 x i8] c"mem_test: fill verification failed\00"
@.str.52 = private unnamed_addr constant [40 x i8] c"mem_test: zero_fill verification failed\00"
@.str.53 = private unnamed_addr constant [33 x i8] c"mem_test: malloc for copy failed\00"
@.str.54 = private unnamed_addr constant [35 x i8] c"mem_test: copy verification failed\00"
@.str.55 = private unnamed_addr constant [12 x i8] c"list_test: \00"
@.str.56 = private unnamed_addr constant [22 x i8] c"list_test: new failed\00"
@.str.57 = private unnamed_addr constant [41 x i8] c"list_test: length incorrect after extend\00"
@.str.58 = private unnamed_addr constant [33 x i8] c"list_test: walk length incorrect\00"
@.str.59 = private unnamed_addr constant [36 x i8] c"list_test: data mismatch for node 1\00"
@.str.60 = private unnamed_addr constant [36 x i8] c"list_test: data mismatch for node 2\00"
@.str.61 = private unnamed_addr constant [36 x i8] c"list_test: data mismatch for node 3\00"
@.str.62 = private unnamed_addr constant [33 x i8] c"list_test: foot pointer mismatch\00"
@.str.63 = private unnamed_addr constant [23 x i8] c"list_test: free failed\00"
@.str.64 = private unnamed_addr constant [45 x i8] c"D:\Projects\rcsharp\src_base_structs.rcsharp\00"
@.str.65 = private unnamed_addr constant [10 x i8] c"fs_test: \00"
@.str.66 = private unnamed_addr constant [47 x i8] c"The quick brown fox jumps over crazy lost dog.\00"
@.str.67 = private unnamed_addr constant [9 x i8] c"test.txt\00"
@.str.68 = private unnamed_addr constant [38 x i8] c"Filesystem test failed, data mismatch\00"
@.str.69 = private unnamed_addr constant [15 x i8] c"\0Aconsole_test:\00"
@.str.70 = private unnamed_addr constant [26 x i8] c"--- VISUAL TEST START ---\00"
@.str.71 = private unnamed_addr constant [22 x i8] c"Printing i64(12345): \00"
@.str.72 = private unnamed_addr constant [23 x i8] c"Printing i64(-67890): \00"
@.str.73 = private unnamed_addr constant [18 x i8] c"Printing i64(0): \00"
@.str.74 = private unnamed_addr constant [27 x i8] c"Printing u64(9876543210): \00"
@.str.75 = private unnamed_addr constant [24 x i8] c"--- VISUAL TEST END ---\00"
@.str.76 = private unnamed_addr constant [12 x i8] c"Exception: \00"
@.str.77 = private unnamed_addr constant [33 x i8] c"Failed to lock heap for walking.\00"
@.str.78 = private unnamed_addr constant [14 x i8] c"Out of memory\00"
@.str.79 = private unnamed_addr constant [17 x i8] c"File not found: \00"
@.str.80 = private unnamed_addr constant [17 x i8] c"File read failed\00"
@.str.81 = private unnamed_addr constant [15 x i8] c"Realloc failed\00"
...
then2:
	...
	br label %endif2
endif2:
	%tmp19 = call i8* @CreateWindowExA(i32 0, i8* @.str.2, i8* @.str.4, i32 13565952, i32 2147483648, i32 2147483648, i32 800, i32 600, i8* null, i8* null, i8* %tmp0, i8* null)
...
define void @tests.run(){
	...
	call void @console.write(i8* @.str.6, i32 19)
...
then0:
	call void @console.write(i8* @.str.7, i32 2)
	br label %func_exit
endif0:
	store i64 %n, i64* %v1
...
define void @tests.process_test(){
	%v0 = alloca %struct.string.String
	%v1 = alloca %struct.string.String
	call void @console.write(i8* @.str.42, i32 14)
...
then3:
	...
	br label %endif3
endif3:
	call void @console.write(i8* @.str.47, i32 17)
	%tmp20 = load i8*, i8** %v0
	...
	call void @console.write(i8* @.str.48, i32 18)
	%tmp23 = load i8*, i8** %v1
...
define void @tests.mem_test(){
	...
	%v1 = alloca i64
	%v2 = alloca i64
	call void @console.write(i8* @.str.49, i32 10)
...
entry:
	...
	call void @console.write(i8* @.str.55, i32 11)
...
define void @tests.funny(){
	...
	%v10 = alloca i32
	%tmp0 = call i32 @fs.create_file(i8* @.str.64)
	%tmp1 = icmp eq i32 %tmp0, 1
	br i1 %tmp1, label %then0, label %endif0
then0:
	call i32 @fs.delete_file(i8* @.str.64)
	br label %func_exit
endif0:
	%tmp2 = call %struct.string.String @fs.read_full_file_as_string(i8* @.str.64)
...
define void @tests.fs_test(){
	...
	%v2 = alloca %struct.string.String
	%v3 = alloca %struct.string.String
	call void @console.write(i8* @.str.65, i32 9)
	%tmp0 = call %struct.string.String @string.from_c_string(i8* @.str.66)
	store %struct.string.String %tmp0, %struct.string.String* %v0
	%tmp1 = call %struct.string.String @process.get_executable_env_path()
	store %struct.string.String %tmp1, %struct.string.String* %v1
	%tmp2 = call %struct.string.String @string.concat_with_c_string(%struct.string.String* %v1, i8* @.str.67)
	store %struct.string.String %tmp2, %struct.string.String* %v2
...
define void @tests.console_test(){
	call void @console.writeln(i8* @.str.69, i32 14)
	call void @console.writeln(i8* @.str.70, i32 25)
	call void @console.write(i8* @.str.71, i32 21)
	call void @console.println_i64(i64 12345)
	call void @console.write(i8* @.str.72, i32 22)
	call void @console.println_i64(i64 -67890)
	call void @console.write(i8* @.str.73, i32 17)
	call void @console.println_i64(i64 0)
	call void @console.write(i8* @.str.74, i32 26)
	call void @console.println_u64(i64 9876543210)
	call void @console.writeln(i8* @.str.75, i32 23)
	call void @console.writeln(i8* @.str.19, i32 2)
	ret void
}
define void @process.throw(i8* %exception)noreturn{
	...
	call void @console.writeln(i8* @.str.76, i32 11)
...
define %struct.string.String @fs.read_full_file_as_string(i8* %path){
	...
	br i1 %tmp2, label %then0, label %endif0
then0:
	%tmp3 = call i8* @string_utils.insert(i8* @.str.79, i8* %path, i32 16)
