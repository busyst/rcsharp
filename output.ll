...
define void @"console.println_u64"(i64 %n){
    ...
    br i1 %tmp2, label %then0, label %endif0
then0:
    %tmp3 = getelementptr inbounds [3 x i8], [3 x i8]* @.str.5, i64 0, i64 0
...
loop_body1_exit:
    ...
    %tmp25 = sub i32 %tmp23, %tmp24
    store i32 %tmp25, i32* %v4
    %tmp26 = load i8*, i8** %v3
    %tmp27 = load i32, i32* %v4
    call void @console.write(i8* %tmp26, i32 %tmp27)
    ret void
}
...
then1:
    %tmp36 = getelementptr inbounds [38 x i8], [38 x i8]* @.str.74, i64 0, i64 0
...
;fn process.throw used times 100
;fn mem.GetProcessHeap used times 8
;fn mem.HeapAlloc used times 2
;fn mem.HeapReAlloc used times 2
...
;fn mem.malloc used times 16
;fn mem.realloc used times 0
;fn mem.free used times 8
;fn mem.copy used times 24
;fn mem.compare used times 2
;fn mem.fill used times 6
;fn mem.zero_fill used times 4
...
;fn string_utils.c_str_len used times 14
...
;fn fs.GetFileAttributesA used times 2
...
;fn fs.file_exists used times 2
...
;fn window.CreateWindowExA used times 4
;fn window.DefWindowProcA used times 4
;fn window.GetMessageA used times 4
;fn window.TranslateMessage used times 4
;fn window.DispatchMessageA used times 4
;fn window.PostQuitMessage used times 8
;fn window.BeginPaint used times 2
;fn window.EndPaint used times 2
;fn window.GetDC used times 0
;fn window.ReleaseDC used times 0
;fn window.LoadCursorA used times 2
;fn window.LoadIconA used times 0
;fn window.LoadImageA used times 2
;fn window.GetClientRect used times 2
;fn window.InvalidateRect used times 2
;fn window.GetModuleHandleA used times 4
;fn window.RegisterClassExA used times 4
;fn window.ShowWindow used times 4
;fn window.CreateCompatibleDC used times 4
;fn window.SelectObject used times 8
;fn window.BitBlt used times 2
;fn window.DeleteDC used times 4
;fn window.DeleteObject used times 0
;fn window.GetObjectA used times 6
;fn window.SetStretchBltMode used times 2
;fn window.StretchBlt used times 2
;fn window.SetWindowLongPtrA used times 2
;fn window.GetWindowLongPtrA used times 2
;fn window.WindowProc used times 2
;fn window.load_bitmap_from_file used times 2
;fn window.get_bitmap_dimensions used times 2
;fn window.draw_bitmap used times 2
;fn window.draw_bitmap_stretched used times 0
;fn window.is_null used times 6
