...
define %struct.string.String @string.concat_with_c_string(%struct.string.String* %src_string, i8* %c_string){
    ...
    %tmp15 = getelementptr inbounds i8, i8* %tmp6, i64 %tmp14
...
then7:
    ...
    br label %endif7
endif7:
    %tmp19 = call i8* @string_utils.insert(i8* @.str.70, i8* @.str.71, i32 1)
    store i32 0, i32* %v0
    br label %loop_body8
loop_body8:
...
logic_rhs_9:
    ...
    %tmp26 = getelementptr inbounds i8, i8* @.str.72, i32 %tmp25
    %tmp27 = load i8, i8* %tmp26
...
endif10:
    ...
    %tmp34 = getelementptr inbounds i8, i8* @.str.72, i32 %tmp33
