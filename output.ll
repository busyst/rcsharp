...
then1:
	...
	br label %endif1
endif1:
	%tmp3 = call i8* @window.load_bitmap_from_file(i8* %imagePath)
...
endif2:
	store i32 0, i32* %v0
	store i32 0, i32* %v1
	call void @window.get_bitmap_dimensions(i8* %tmp3, i32* %v0, i32* %v1)
	%tmp5 = or i32 2, 1
	%tmp6 = add i32 5, 1
	%tmp7 = sext i32 %tmp6 to i64
	%tmp8 = inttoptr i64 %tmp7 to i8*
	%tmp9 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v2, i32 0, i32 0
	store i32 80, i32* %tmp9
	%tmp10 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v2, i32 0, i32 1
	store i32 %tmp5, i32* %tmp10
	...
	store i8* %tmp0, i8** %tmp14
	%tmp15 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v2, i32 0, i32 6
	store i8* null, i8** %tmp15
	%tmp16 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v2, i32 0, i32 7
	store i8* null, i8** %tmp16
	%tmp17 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v2, i32 0, i32 8
	store i8* %tmp8, i8** %tmp17
	%tmp18 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v2, i32 0, i32 9
	store i8* null, i8** %tmp18
	%tmp19 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v2, i32 0, i32 10
	store i8* @.str.2, i8** %tmp19
	%tmp20 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v2, i32 0, i32 11
	store i8* null, i8** %tmp20
	%tmp21 = call i16 @RegisterClassExA(%struct.window.WNDCLASSEXA* %v2)
	%tmp22 = icmp eq i16 %tmp21, 0
	br i1 %tmp22, label %then3, label %endif3
then3:
	call void @process.throw(i8* @.str.3)
	br label %endif3
endif3:
	%tmp23 = or i32 2147483648, 268435456
	%tmp24 = load i32, i32* %v0
	%tmp25 = load i32, i32* %v1
	%tmp26 = call i8* @CreateWindowExA(i32 8, i8* @.str.2, i8* @.str.4, i32 %tmp23, i32 100, i32 100, i32 %tmp24, i32 %tmp25, i8* null, i8* null, i8* %tmp0, i8* null)
	br label %inl_entry4
inl_entry4:
	%tmp27 = icmp eq ptr %tmp26, null
	br label %inl_exit4
inl_exit4:
	%tmp28 = phi i1 [ %tmp27, %inl_entry4 ]
	br i1 %tmp28, label %then5, label %endif5
then5:
	call void @process.throw(i8* @.str.5)
	br label %endif5
endif5:
	call i64 @SetWindowLongPtrA(i8* %tmp26, i32 -21, i8* %tmp3)
	call i32 @ShowWindow(i8* %tmp26, i32 5)
	call i32 @GetClientRect(i8* %tmp26, %struct.window.RECT* %v3)
	call i32 @InvalidateRect(i8* %tmp26, %struct.window.RECT* %v3, i32 1)
	br label %loop_body6
loop_body6:
	%tmp29 = call i32 @GetMessageA(%struct.window.MSG* %v4, i8* null, i32 0, i32 0)
	%tmp30 = icmp sle i32 %tmp29, 0
...
endif1:
	...
	%tmp9 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v0, i32 0, i32 2
	store i64 (i8*, i32, i64, i64)* @window.WindowProc, i64 (i8*, i32, i64, i64)** %tmp9
	%tmp10 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v0, i32 0, i32 3
	store i32 0, i32* %tmp10
	%tmp11 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v0, i32 0, i32 4
	store i32 0, i32* %tmp11
	%tmp12 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v0, i32 0, i32 5
	store i8* %tmp0, i8** %tmp12
	%tmp13 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v0, i32 0, i32 6
	...
	%tmp15 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v0, i32 0, i32 8
	store i8* %tmp6, i8** %tmp15
...
then2:
	...
	br label %endif2
endif2:
	%tmp21 = call i8* @CreateWindowExA(i32 0, i8* @.str.6, i8* @.str.7, i32 13565952, i32 2147483648, i32 2147483648, i32 800, i32 600, i8* null, i8* null, i8* %tmp0, i8* null)
	br label %inl_entry3
inl_entry3:
...
then7:
	...
	br label %endif7
endif7:
	%tmp19 = call i8* @string_utils.insert(i8* @.str.28, i8* @.str.29, i32 1)
	store i32 0, i32* %v0
	br label %loop_body8
loop_body8:
...
logic_rhs_9:
	...
	%tmp26 = getelementptr inbounds i8, i8* @.str.30, i32 %tmp25
...
endif10:
	...
	%tmp34 = getelementptr inbounds i8, i8* @.str.30, i32 %tmp33
...
entry:
	...
	%tmp9 = sext i32 %tmp0 to i64
	call void @mem.copy(i8* %c_string, i8* %tmp8, i64 %tmp9)
	%tmp10 = getelementptr inbounds %struct.string.String, %struct.string.String* %v0, i32 0, i32 0
	%tmp11 = getelementptr inbounds %struct.string.String, %struct.string.String* %v0, i32 0, i32 0
	%tmp12 = load i8*, i8** %tmp11
	%tmp13 = getelementptr inbounds i8, i8* %tmp12, i32 %tmp0
	store i8 0, i8* %tmp13
...
entry:
	...
	%tmp14 = sext i32 %tmp1 to i64
	call void @mem.copy(i8* %tmp11, i8* %tmp13, i64 %tmp14)
	%tmp15 = getelementptr inbounds %struct.string.String, %struct.string.String* %v0, i32 0, i32 0
	%tmp16 = getelementptr inbounds %struct.string.String, %struct.string.String* %v0, i32 0, i32 0
	%tmp17 = load i8*, i8** %tmp16
	%tmp18 = getelementptr inbounds i8, i8* %tmp17, i32 %tmp1
	store i8 0, i8* %tmp18
...
entry:
	%v0 = alloca i32; var: i
	%v1 = alloca i64; var: sign
	%v2 = alloca i32; var: b
	%tmp33 = alloca i1
	%tmp39 = alloca i1
	%v3 = alloca i64; var: result
	%v4 = alloca i32; var: digit_val
	store i32 0, i32* %v0
	br label %loop_body0
loop_body0:
	%tmp0 = load i32, i32* %v0
...
endif4:
	...
	store i1 %tmp32, i1* %tmp33
	br i1 %tmp32, label %logic_rhs_7, label %logic_end_7
logic_rhs_7:
	%tmp34 = load i32, i32* %v0
	%tmp35 = getelementptr inbounds i8, i8* %str, i32 %tmp34
	%tmp36 = load i8, i8* %tmp35
	%tmp37 = icmp eq i8 %tmp36, 48
	store i1 %tmp37, i1* %tmp33
	br label %logic_end_7
logic_end_7:
	%tmp38 = load i1, i1* %tmp33
	store i1 %tmp38, i1* %tmp39
	br i1 %tmp38, label %logic_rhs_8, label %logic_end_8
logic_rhs_8:
	%tmp40 = load i32, i32* %v0
	%tmp41 = add i32 %tmp40, 1
	%tmp42 = getelementptr inbounds i8, i8* %str, i32 %tmp41
	%tmp43 = load i8, i8* %tmp42
	%tmp44 = call i8 @char_utils.to_lower(i8 %tmp43)
	%tmp45 = icmp eq i8 %tmp44, 120
	store i1 %tmp45, i1* %tmp39
	br label %logic_end_8
logic_end_8:
	%tmp46 = load i1, i1* %tmp39
	br i1 %tmp46, label %then9, label %endif9
then9:
	%tmp47 = load i32, i32* %v0
	%tmp48 = add i32 %tmp47, 2
...
loop_body10:
	...
	%tmp50 = getelementptr inbounds i8, i8* %str, i32 %tmp49
	%tmp51 = load i8, i8* %tmp50
	%tmp52 = call i1 @char_utils.is_digit(i8 %tmp51)
	br i1 %tmp52, label %then11, label %else11
then11:
	%tmp53 = sub i8 %tmp51, 48
	%tmp54 = sext i8 %tmp53 to i32
	store i32 %tmp54, i32* %v4
	br label %endif11
else11:
	%tmp55 = call i1 @char_utils.is_alpha(i8 %tmp51)
	br i1 %tmp55, label %then12, label %else12
then12:
	%tmp56 = call i8 @char_utils.to_lower(i8 %tmp51)
	%tmp57 = sub i8 %tmp56, 97
	%tmp58 = add i8 %tmp57, 10
	%tmp59 = sext i8 %tmp58 to i32
	store i32 %tmp59, i32* %v4
	br label %endif12
else12:
...
endif12:
	br label %endif11
endif11:
	%tmp60 = load i32, i32* %v4
	%tmp61 = load i32, i32* %v2
	%tmp62 = icmp sge i32 %tmp60, %tmp61
	br i1 %tmp62, label %then13, label %endif13
then13:
	br label %loop_body10_exit
endif13:
	%tmp63 = load i64, i64* %v3
	%tmp64 = load i32, i32* %v2
	%tmp65 = sext i32 %tmp64 to i64
	%tmp66 = mul i64 %tmp63, %tmp65
	%tmp67 = load i32, i32* %v4
	%tmp68 = sext i32 %tmp67 to i64
	%tmp69 = add i64 %tmp66, %tmp68
	store i64 %tmp69, i64* %v3
	%tmp70 = load i32, i32* %v0
	%tmp71 = add i32 %tmp70, 1
	store i32 %tmp71, i32* %v0
	br label %loop_body10
loop_body10_exit:
	%tmp72 = icmp ne ptr %endptr, null
	br i1 %tmp72, label %then14, label %endif14
then14:
	%tmp73 = load i32, i32* %v0
	%tmp74 = sext i32 %tmp73 to i64
	%tmp75 = getelementptr inbounds i8, i8* %str, i64 %tmp74
	store i8* %tmp75, i8** %endptr
	br label %endif14
endif14:
	%tmp76 = load i64, i64* %v3
	%tmp77 = load i64, i64* %v1
	%tmp78 = mul i64 %tmp76, %tmp77
	br label %func_exit
func_exit:
	ret i64 %tmp78
}
...
entry:
	%v0 = alloca i32; var: res
	%v1 = alloca i32; var: sign
	%v2 = alloca i32; var: i
	store i32 0, i32* %v0
	store i32 1, i32* %v1
	store i32 0, i32* %v2
...
entry:
	...
	br i1 %tmp2, label %then0, label %endif0
then0:
	%tmp3 = call i8* @string_utils.insert(i8* @.str.81, i8* %path, i32 16)
...
endif0:
	br label %func_exit
func_exit:
	%final_ret = phi i8 [ %tmp1, %then0 ], [ %c, %endif0 ]
	ret i8 %final_ret
}
...
logic_rhs_3:
	...
	br label %logic_end_3
logic_end_3:
	%tmp12 = load i1, i1* %tmp10
	store i1 %tmp12, i1* %tmp13
	br i1 %tmp12, label %logic_end_4, label %logic_rhs_4
logic_rhs_4:
	%tmp14 = icmp eq i8 %c, 13
	store i1 %tmp14, i1* %tmp13
	br label %logic_end_4
logic_end_4:
	%tmp15 = load i1, i1* %tmp13
	br label %func_exit
func_exit:
	ret i1 %tmp15
}
...
entry:
	...
	br i1 %tmp0, label %logic_rhs_0, label %logic_end_0
logic_rhs_0:
	%tmp2 = call i1 @char_utils.is_alnum(i8 %c)
	%tmp3 = xor i1 1, %tmp2
...
logic_end_1:
	...
	br i1 %tmp9, label %logic_end_3, label %logic_rhs_3
logic_rhs_3:
	%tmp11 = icmp sge i8 %c, 48
	store i1 %tmp11, i1* %tmp12
	br i1 %tmp11, label %logic_rhs_4, label %logic_end_4
logic_rhs_4:
	%tmp13 = icmp sle i8 %c, 57
	store i1 %tmp13, i1* %tmp12
	br label %logic_end_4
logic_end_4:
	%tmp14 = load i1, i1* %tmp12
