...
@.str.2 = private unnamed_addr constant [6 x i8] c"\09---\0A\00"
@.str.3 = private unnamed_addr alias [2 x i8], [2 x i8]* bitcast (i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 4) to [2 x i8]*)
@.str.4 = private unnamed_addr constant [17 x i8] c"File not found: \00"
@.str.5 = private unnamed_addr constant [17 x i8] c"File read failed\00"
@.str.6 = private unnamed_addr constant [34 x i8] c"Expected name after hint symbol #\00"
@.str.7 = private unnamed_addr constant [37 x i8] c"Expected ')' after arguments in hint\00"
@.str.8 = private unnamed_addr constant [42 x i8] c"Expected ']' after arguments in attribute\00"
@.str.9 = private unnamed_addr constant [34 x i8] c"Expected function name after 'fn'\00"
@.str.10 = private unnamed_addr constant [40 x i8] c"Expected '(' or '<' after function name\00"
@.str.11 = private unnamed_addr constant [38 x i8] c"Expected ')' after function arguments\00"
@.str.12 = private unnamed_addr constant [24 x i8] c"Expected namespace name\00"
@.str.13 = private unnamed_addr constant [40 x i8] c"Expected namespace body after namespace\00"
@.str.14 = private unnamed_addr constant [19 x i8] c"Expected enum name\00"
@.str.15 = private unnamed_addr constant [27 x i8] c"Expected '{' for enum body\00"
@.str.16 = private unnamed_addr constant [21 x i8] c"Expected struct name\00"
@.str.17 = private unnamed_addr constant [29 x i8] c"Expected '{' for struct body\00"
@.str.18 = private unnamed_addr constant [50 x i8] c"Expected this be a constant or static declaration\00"
@.str.19 = private unnamed_addr constant [24 x i8] c"Expected Colon and Type\00"
@.str.20 = private unnamed_addr constant [33 x i8] c"Expected SemiColon or expression\00"
@.str.21 = private unnamed_addr constant [19 x i8] c"Expected SemiColon\00"
@.str.22 = private unnamed_addr constant [7 x i8] c"@@@@\0A\0D\00"
@.str.23 = private unnamed_addr constant [21 x i8] c"--UNEXPECTED TOKEN--\00"
@.str.24 = private unnamed_addr constant [9 x i8] c"ACHTUNG:\00"
@.str.25 = private unnamed_addr constant [24 x i8] c"Character not expected!\00"
@.str.26 = private unnamed_addr constant [3 x i8] c", \00"
@.str.27 = private unnamed_addr constant [3 x i8] c"#[\00"
@.str.28 = private unnamed_addr constant [3 x i8] c"]\0A\00"
@.str.29 = private unnamed_addr constant [4 x i8] c"fn \00"
@.str.30 = private unnamed_addr alias [3 x i8], [3 x i8]* bitcast (i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.1, i64 0, i64 25) to [3 x i8]*)
@.str.31 = private unnamed_addr constant [3 x i8] c"{\0A\00"
@.str.32 = private unnamed_addr constant [8 x i8] c"struct \00"
@.str.33 = private unnamed_addr alias [2 x i8], [2 x i8]* bitcast (i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.138, i64 0, i64 3) to [2 x i8]*)
@.str.34 = private unnamed_addr constant [3 x i8] c"}\0A\00"
@.str.35 = private unnamed_addr constant [6 x i8] c"enum \00"
@.str.36 = private unnamed_addr constant [11 x i8] c"namespace \00"
@.str.37 = private unnamed_addr alias [7 x i8], [7 x i8]* bitcast (i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.176, i64 0, i64 1) to [7 x i8]*)
@.str.38 = private unnamed_addr alias [8 x i8], [8 x i8]* bitcast (i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.177, i64 0, i64 1) to [8 x i8]*)
@.str.39 = private unnamed_addr constant [32 x i8] c"let is not allowed in top scope\00"
@.str.40 = private unnamed_addr constant [4 x i8] c" : \00"
@.str.41 = private unnamed_addr constant [4 x i8] c" = \00"
@.str.42 = private unnamed_addr alias [3 x i8], [3 x i8]* bitcast (i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.22, i64 0, i64 4) to [3 x i8]*)
@.str.43 = private unnamed_addr constant [25 x i8] c"--UNEXPECTED STATEMENT--\00"
@.str.44 = private unnamed_addr constant [12 x i8] c"Exception: \00"
@.str.45 = private unnamed_addr constant [14 x i8] c"Out of memory\00"
@.str.46 = private unnamed_addr constant [3 x i8] c"0\0A\00"
@.str.47 = private unnamed_addr constant [26 x i8] c"stdout handle was invalid\00"
@.str.48 = private unnamed_addr constant [5 x i8] c"CHAR\00"
@.str.49 = private unnamed_addr constant [5 x i8] c"NAME\00"
@.str.50 = private unnamed_addr constant [7 x i8] c"STRING\00"
@.str.51 = private unnamed_addr constant [8 x i8] c"INTEGER\00"
@.str.52 = private unnamed_addr constant [8 x i8] c"DECIMAL\00"
@.str.53 = private unnamed_addr constant [2 x i8] c"(\00"
@.str.54 = private unnamed_addr alias [2 x i8], [2 x i8]* bitcast (i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.189, i64 0, i64 50) to [2 x i8]*)
@.str.55 = private unnamed_addr constant [2 x i8] c"{\00"
@.str.56 = private unnamed_addr constant [2 x i8] c"}\00"
@.str.57 = private unnamed_addr alias [2 x i8], [2 x i8]* bitcast (i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.27, i64 0, i64 1) to [2 x i8]*)
@.str.58 = private unnamed_addr constant [2 x i8] c"]\00"
@.str.59 = private unnamed_addr alias [2 x i8], [2 x i8]* bitcast (i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.24, i64 0, i64 7) to [2 x i8]*)
...
@.str.63 = private unnamed_addr alias [2 x i8], [2 x i8]* bitcast (i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.64, i64 0, i64 1) to [2 x i8]*)
@.str.64 = private unnamed_addr constant [3 x i8] c"..\00"
@.str.65 = private unnamed_addr constant [4 x i8] c"..=\00"
@.str.66 = private unnamed_addr constant [3 x i8] c"=>\00"
@.str.67 = private unnamed_addr alias [2 x i8], [2 x i8]* bitcast (i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.6, i64 0, i64 32) to [2 x i8]*)
@.str.68 = private unnamed_addr alias [2 x i8], [2 x i8]* bitcast (i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.65, i64 0, i64 2) to [2 x i8]*)
@.str.69 = private unnamed_addr constant [2 x i8] c"+\00"
@.str.70 = private unnamed_addr alias [2 x i8], [2 x i8]* bitcast (i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.23, i64 0, i64 19) to [2 x i8]*)
...
@.str.74 = private unnamed_addr alias [2 x i8], [2 x i8]* bitcast (i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.25, i64 0, i64 22) to [2 x i8]*)
...
@.str.79 = private unnamed_addr alias [2 x i8], [2 x i8]* bitcast (i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.66, i64 0, i64 1) to [2 x i8]*)
...
@.str.84 = private unnamed_addr alias [2 x i8], [2 x i8]* bitcast (i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.77, i64 0, i64 1) to [2 x i8]*)
@.str.85 = private unnamed_addr alias [2 x i8], [2 x i8]* bitcast (i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.78, i64 0, i64 1) to [2 x i8]*)
@.str.86 = private unnamed_addr constant [2 x i8] c"^\00"
@.str.87 = private unnamed_addr constant [4 x i8] c"PUB\00"
@.str.88 = private unnamed_addr constant [7 x i8] c"INLINE\00"
@.str.89 = private unnamed_addr constant [6 x i8] c"CONST\00"
@.str.90 = private unnamed_addr constant [7 x i8] c"EXTERN\00"
@.str.91 = private unnamed_addr constant [6 x i8] c"MATCH\00"
@.str.92 = private unnamed_addr constant [3 x i8] c"FN\00"
@.str.93 = private unnamed_addr constant [4 x i8] c"LET\00"
@.str.94 = private unnamed_addr constant [7 x i8] c"STATIC\00"
@.str.95 = private unnamed_addr constant [3 x i8] c"AS\00"
@.str.96 = private unnamed_addr constant [3 x i8] c"IF\00"
@.str.97 = private unnamed_addr constant [5 x i8] c"ELSE\00"
@.str.98 = private unnamed_addr constant [6 x i8] c"TRAIT\00"
@.str.99 = private unnamed_addr constant [5 x i8] c"IMPL\00"
@.str.100 = private unnamed_addr constant [7 x i8] c"STRUCT\00"
@.str.101 = private unnamed_addr constant [5 x i8] c"ENUM\00"
@.str.102 = private unnamed_addr constant [5 x i8] c"LOOP\00"
@.str.103 = private unnamed_addr constant [4 x i8] c"FOR\00"
@.str.104 = private unnamed_addr constant [3 x i8] c"DO\00"
@.str.105 = private unnamed_addr constant [3 x i8] c"IN\00"
@.str.106 = private unnamed_addr constant [6 x i8] c"WHILE\00"
@.str.107 = private unnamed_addr constant [6 x i8] c"BREAK\00"
@.str.108 = private unnamed_addr constant [9 x i8] c"CONTINUE\00"
@.str.109 = private unnamed_addr constant [7 x i8] c"RETURN\00"
@.str.110 = private unnamed_addr constant [5 x i8] c"THIS\00"
@.str.111 = private unnamed_addr constant [9 x i8] c"OPERATOR\00"
@.str.112 = private unnamed_addr constant [10 x i8] c"NAMESPACE\00"
@.str.113 = private unnamed_addr constant [5 x i8] c"TRUE\00"
@.str.114 = private unnamed_addr constant [6 x i8] c"FALSE\00"
@.str.115 = private unnamed_addr constant [5 x i8] c"NULL\00"
@.str.116 = private unnamed_addr constant [14 x i8] c"UNKNOWN_TOKEN\00"
@.str.117 = private unnamed_addr constant [20 x i8] c"Expected field name\00"
@.str.118 = private unnamed_addr constant [30 x i8] c"Expected ':' after field name\00"
@.str.119 = private unnamed_addr constant [39 x i8] c"Expected ',' or '}' after struct field\00"
@.str.120 = private unnamed_addr constant [31 x i8] c"Expected '}' after struct body\00"
@.str.121 = private unnamed_addr constant [36 x i8] c"Expected generic type name or comma\00"
@.str.122 = private unnamed_addr constant [38 x i8] c"Expected '>' after generic parameters\00"
@.str.123 = private unnamed_addr constant [27 x i8] c"Expected enum variant name\00"
@.str.124 = private unnamed_addr constant [39 x i8] c"Expected ',' or '}' after enum variant\00"
@.str.125 = private unnamed_addr constant [29 x i8] c"Expected '}' after enum body\00"
@.str.126 = private unnamed_addr constant [37 x i8] c"Expected ';' after return expression\00"
@.str.127 = private unnamed_addr constant [58 x i8] c"Expected variable name after variable declaration keyword\00"
@.str.128 = private unnamed_addr constant [58 x i8] c"Expected ':' after variable deflaration to indicate type.\00"
@.str.129 = private unnamed_addr constant [49 x i8] c"Expected ';' at the end of variable declaration.\00"
@.str.130 = private unnamed_addr constant [41 x i8] c"Expected '{' as the begining of if body.\00"
@.str.131 = private unnamed_addr constant [24 x i8] c"Expected '{' after else\00"
@.str.132 = private unnamed_addr constant [44 x i8] c"Expected '{' as the begining of while body.\00"
@.str.133 = private unnamed_addr constant [31 x i8] c"Expected while after do block.\00"
@.str.134 = private unnamed_addr constant [49 x i8] c"Expected semicolon after do {} while expression.\00"
@.str.135 = private unnamed_addr constant [45 x i8] c"Expected name of iterator after for keyword.\00"
@.str.136 = private unnamed_addr constant [41 x i8] c"Expected in after name in for structure.\00"
@.str.137 = private unnamed_addr constant [39 x i8] c"Expected ';' at the end of expression.\00"
@.str.138 = private unnamed_addr constant [5 x i8] c"---\09\00"
@.str.139 = private unnamed_addr constant [6 x i8] c"todo!\00"
@.str.140 = private unnamed_addr constant [23 x i8] c"Expected argument name\00"
@.str.141 = private unnamed_addr constant [33 x i8] c"Expected ':' after argument name\00"
@.str.142 = private unnamed_addr constant [35 x i8] c"Expected ',' or ')' after argument\00"
@.str.143 = private unnamed_addr constant [3 x i8] c"if\00"
@.str.144 = private unnamed_addr constant [3 x i8] c"do\00"
@.str.145 = private unnamed_addr constant [3 x i8] c"as\00"
@.str.146 = private unnamed_addr constant [3 x i8] c"in\00"
@.str.147 = private unnamed_addr constant [3 x i8] c"fn\00"
@.str.148 = private unnamed_addr constant [4 x i8] c"let\00"
@.str.149 = private unnamed_addr constant [4 x i8] c"pub\00"
@.str.150 = private unnamed_addr constant [4 x i8] c"for\00"
@.str.151 = private unnamed_addr constant [5 x i8] c"true\00"
@.str.152 = private unnamed_addr constant [5 x i8] c"loop\00"
@.str.153 = private unnamed_addr constant [5 x i8] c"this\00"
@.str.154 = private unnamed_addr constant [5 x i8] c"null\00"
@.str.155 = private unnamed_addr alias [5 x i8], [5 x i8]* bitcast (i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.131, i64 0, i64 19) to [5 x i8]*)
@.str.156 = private unnamed_addr constant [5 x i8] c"enum\00"
@.str.157 = private unnamed_addr constant [5 x i8] c"impl\00"
@.str.158 = private unnamed_addr constant [6 x i8] c"const\00"
@.str.159 = private unnamed_addr constant [6 x i8] c"match\00"
@.str.160 = private unnamed_addr constant [6 x i8] c"trait\00"
@.str.161 = private unnamed_addr constant [6 x i8] c"while\00"
@.str.162 = private unnamed_addr constant [6 x i8] c"break\00"
@.str.163 = private unnamed_addr constant [6 x i8] c"false\00"
@.str.164 = private unnamed_addr constant [7 x i8] c"inline\00"
@.str.165 = private unnamed_addr constant [7 x i8] c"extern\00"
@.str.166 = private unnamed_addr constant [7 x i8] c"static\00"
@.str.167 = private unnamed_addr constant [7 x i8] c"struct\00"
@.str.168 = private unnamed_addr constant [7 x i8] c"return\00"
@.str.169 = private unnamed_addr constant [9 x i8] c"continue\00"
@.str.170 = private unnamed_addr alias [9 x i8], [9 x i8]* bitcast (i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.208, i64 0, i64 14) to [9 x i8]*)
@.str.171 = private unnamed_addr alias [10 x i8], [10 x i8]* bitcast (i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.13, i64 0, i64 30) to [10 x i8]*)
@.str.172 = private unnamed_addr constant [26 x i8] c"Invalid escape character!\00"
@.str.173 = private unnamed_addr constant [17 x i8] c"Char is too long\00"
@.str.174 = private unnamed_addr constant [5 x i8] c"-->\09\00"
@.str.175 = private unnamed_addr constant [6 x i8] c"\09<--\0A\00"
@.str.176 = private unnamed_addr constant [8 x i8] c"\09const \00"
@.str.177 = private unnamed_addr constant [9 x i8] c"\09static \00"
@.str.178 = private unnamed_addr constant [6 x i8] c"\09let \00"
@.str.179 = private unnamed_addr constant [5 x i8] c">>>\09\00"
@.str.180 = private unnamed_addr constant [9 x i8] c"\09return \00"
@.str.181 = private unnamed_addr constant [44 x i8] c"Unexpected end of tokens while parsing type\00"
@.str.182 = private unnamed_addr constant [41 x i8] c"Expected '(' after 'fn' in function type\00"
@.str.183 = private unnamed_addr constant [50 x i8] c"Expected ')' to close function type argument list\00"
@.str.184 = private unnamed_addr constant [49 x i8] c"Expected ':' before return type in function type\00"
@.str.185 = private unnamed_addr constant [38 x i8] c"Expected ';' in fixed-size array type\00"
@.str.186 = private unnamed_addr constant [44 x i8] c"Expected ']' to close fixed-size array type\00"
@.str.187 = private unnamed_addr constant [56 x i8] c"Qualified type path exceeds maximum depth of 8 segments\00"
@.str.188 = private unnamed_addr constant [49 x i8] c"Expected identifier after '::' in qualified type\00"
@.str.189 = private unnamed_addr constant [52 x i8] c"Expected a type (unexpected token in type position)\00"
@.str.190 = private unnamed_addr constant [39 x i8] c"Unexpected end of tokens in expression\00"
@.str.191 = private unnamed_addr constant [44 x i8] c"Expected ')' after parenthesized expression\00"
@.str.192 = private unnamed_addr constant [37 x i8] c"Expected ',' or ']' in array literal\00"
@.str.193 = private unnamed_addr constant [33 x i8] c"Expected ']' after array literal\00"
...
@.str.196 = private unnamed_addr constant [31 x i8] c"Expected ']' after array index\00"
@.str.197 = private unnamed_addr constant [41 x i8] c"Expected ',' or '>' in generic arguments\00"
@.str.198 = private unnamed_addr constant [37 x i8] c"Expected '>' after generic arguments\00"
@.str.199 = private unnamed_addr constant [45 x i8] c"Expected field name in struct initialization\00"
@.str.200 = private unnamed_addr constant [45 x i8] c"Expected ',' or '}' in struct initialization\00"
@.str.201 = private unnamed_addr constant [41 x i8] c"Expected '}' after struct initialization\00"
@.str.202 = private unnamed_addr constant [32 x i8] c"Expected member name after '::'\00"
@.str.203 = private unnamed_addr constant [31 x i8] c"Expected member name after '.'\00"
@.str.204 = private unnamed_addr constant [37 x i8] c"Pointer depth exceeds maximum of 255\00"
@.str.205 = private unnamed_addr constant [13 x i8] c"Not expected\00"
@.str.206 = private unnamed_addr constant [55 x i8] c"Unexpected end of tokens inside generic type arguments\00"
@.str.207 = private unnamed_addr constant [51 x i8] c"Expected ',' or '>' between generic type arguments\00"
@.str.208 = private unnamed_addr constant [23 x i8] c"Invalid unary operator\00"
@.str.209 = private unnamed_addr constant [24 x i8] c"Invalid binary operator\00"
@.str.210 = private unnamed_addr constant [15 x i8] c"Realloc failed\00"
...
define void @main(){
	...
	%tmp10 = call %struct.string.String @string.empty()
	store %struct.string.String %tmp10, %struct.string.String* %v4
	call void @compile(%"struct.vector.Vec<%struct.Stmt>"* %v3, %"struct.vector.Vec<%struct.string.String>"* %v2, %struct.string.String* %v4)
	call void @console.write(i8* @.str.2, i32 5)
	call void @console.write_string(%struct.string.String* %v4)
	call void @console.write(i8* @.str.3, i32 1)
...
then0:
	%tmp3 = call i8* @string_utils.insert(i8* @.str.4, i8* %path, i32 16)
...
define void @parse(%struct.TokenData* %token_array, i32 %token_len, %"struct.vector.Vec<%struct.string.String>"* %symbol_vector, %"struct.vector.Vec<%struct.Stmt>"* %statement_vector){
	...
	%v12 = alloca %struct.Type*
	%v13 = alloca %"struct.vector.Vec<%struct.EnumField>"
	%v14 = alloca %struct.Stmt
	%v15 = alloca %"struct.vector.Vec<i16>"
	%v16 = alloca %"struct.vector.Vec<%struct.Argument>"
	%v17 = alloca %struct.Stmt
	%v18 = alloca %"struct.vector.Vec<%struct.Stmt>"
	%v19 = alloca i32
	%v20 = alloca %struct.Type*
	%v21 = alloca i32
	%v22 = alloca %struct.string.String
...
then8:
	...
	call void @expect(%struct.TokenData* %token_array, i32* %v0, i32 %token_len, i8 1, i8* @.str.7)
	br label %endif8
endif8:
	store i8 0, i8* %v4
	%tmp39 = load i1, i1* %v2
...
then9:
	call void @expect(%struct.TokenData* %token_array, i32* %v0, i32 %token_len, i8 5, i8* @.str.8)
	store i8 20, i8* %v4
	br label %endif9
endif9:
...
loop_start19:
	...
	%tmp108 = icmp ult i32 %tmp107, %token_len
	br i1 %tmp108, label %logic_rhs_20, label %logic_end_20
logic_rhs_20:
	...
	%tmp112 = icmp ne i8 %tmp111, 8
	br label %logic_end_20
logic_end_20:
	%tmp113 = phi i1 [%tmp108, %loop_start19], [%tmp112, %logic_rhs_20]
	br i1 %tmp113, label %endif21, label %else21
else21:
...
loop_body19_exit:
	...
	%tmp117 = getelementptr inbounds %struct.TokenData, %struct.TokenData* %token_array, i32 %tmp116
	%tmp118 = load i8, i8* %tmp117
	%tmp119 = icmp eq i8 %tmp118, 8
	br i1 %tmp119, label %then22, label %endif22
then22:
...
else18:
	...
	%tmp123 = getelementptr inbounds %struct.TokenData, %struct.TokenData* %token_array, i32 %tmp122
	%tmp124 = load i8, i8* %tmp123
	%tmp125 = icmp eq i8 %tmp124, 8
	br i1 %tmp125, label %then23, label %endif23
then23:
	%tmp126 = load i32, i32* %v0
	%tmp127 = add i32 %tmp126, 1
	store i32 %tmp127, i32* %v0
	br label %endif23
endif23:
	br label %endif18
endif18:
	br label %endif17
endif17:
	%tmp128 = call i8* @mem.malloc(i64 64)
	store i16 %tmp56, i16* %tmp128
	%tmp129 = getelementptr inbounds %struct.FnNode, %struct.FnNode* %tmp128, i32 0, i32 1
	%tmp130 = load %"struct.vector.Vec<%struct.Argument>", %"struct.vector.Vec<%struct.Argument>"* %v6
	store %"struct.vector.Vec<%struct.Argument>" %tmp130, %"struct.vector.Vec<%struct.Argument>"* %tmp129
	%tmp131 = getelementptr inbounds %struct.FnNode, %struct.FnNode* %tmp128, i32 0, i32 2
	%tmp132 = load %struct.Type*, %struct.Type** %v7
	store %struct.Type* %tmp132, %struct.Type** %tmp131
	%tmp133 = getelementptr inbounds %struct.FnNode, %struct.FnNode* %tmp128, i32 0, i32 3
	%tmp134 = call %"struct.vector.Vec<i16>" @"vector.new<i16>"()
	store %"struct.vector.Vec<i16>" %tmp134, %"struct.vector.Vec<i16>"* %tmp133
	%tmp135 = getelementptr inbounds %struct.FnNode, %struct.FnNode* %tmp128, i32 0, i32 4
	%tmp136 = load %"struct.vector.Vec<%struct.Stmt>", %"struct.vector.Vec<%struct.Stmt>"* %v8
	store %"struct.vector.Vec<%struct.Stmt>" %tmp136, %"struct.vector.Vec<%struct.Stmt>"* %tmp135
	store i8 11, i8* %v9
	%tmp137 = getelementptr inbounds %struct.Stmt, %struct.Stmt* %v9, i32 0, i32 1
	store i8* %tmp128, i8** %tmp137
	%tmp138 = load %struct.Stmt, %struct.Stmt* %v9
	call void @"vector.push<%struct.Stmt>"(%"struct.vector.Vec<%struct.Stmt>"* %statement_vector, %struct.Stmt %tmp138)
	br label %loop_body1
; Variable stmt is out.
; Variable nodes is out.
; Variable args is out.
endif10:
	%tmp139 = icmp eq i8 %tmp5, 61
...
then24:
	...
	%tmp145 = icmp ne i8 %tmp144, 65
	br i1 %tmp145, label %then25, label %endif25
then25:
	call void @process.throw(i8* @.str.12)
	br label %endif25
endif25:
	%tmp146 = load i32, i32* %v0
	%tmp147 = getelementptr inbounds %struct.TokenData, %struct.TokenData* %token_array, i32 %tmp146
	%tmp148 = getelementptr inbounds %struct.TokenData, %struct.TokenData* %tmp147, i32 0, i32 1
	%tmp149 = load i16, i16* %tmp148
	%tmp150 = load i32, i32* %v0
	%tmp151 = add i32 %tmp150, 1
	store i32 %tmp151, i32* %v0
	%tmp152 = call %"struct.vector.Vec<%struct.Stmt>" @"vector.new<%struct.Stmt>"()
	store %"struct.vector.Vec<%struct.Stmt>" %tmp152, %"struct.vector.Vec<%struct.Stmt>"* %v10
	%tmp153 = load i32, i32* %v0
	%tmp154 = getelementptr inbounds %struct.TokenData, %struct.TokenData* %token_array, i32 %tmp153
	%tmp155 = load i8, i8* %tmp154
	%tmp156 = icmp eq i8 %tmp155, 2
	br i1 %tmp156, label %then26, label %else26
then26:
	%tmp157 = load i32, i32* %v0
	%tmp158 = add i32 %tmp157, 1
	call void @skip_nested(%struct.TokenData* %token_array, i32* %v0, i32 %token_len, i8 2, i8 3)
	%tmp159 = load i32, i32* %v0
	%tmp160 = sub i32 %tmp159, 1
	%tmp161 = sub i32 %tmp160, %tmp158
	%tmp162 = getelementptr inbounds %struct.TokenData, %struct.TokenData* %token_array, i32 %tmp158
	call void @parse(%struct.TokenData* %tmp162, i32 %tmp161, %"struct.vector.Vec<%struct.string.String>"* %symbol_vector, %"struct.vector.Vec<%struct.Stmt>"* %v10)
	br label %endif26
else26:
	call void @process.throw(i8* @.str.13)
	br label %endif26
endif26:
	%tmp163 = call i8* @mem.malloc(i64 24)
	store i16 %tmp149, i16* %tmp163
	%tmp164 = getelementptr inbounds %struct.NamespaceNode, %struct.NamespaceNode* %tmp163, i32 0, i32 1
	%tmp165 = load %"struct.vector.Vec<%struct.Stmt>", %"struct.vector.Vec<%struct.Stmt>"* %v10
	store %"struct.vector.Vec<%struct.Stmt>" %tmp165, %"struct.vector.Vec<%struct.Stmt>"* %tmp164
	store i8 14, i8* %v11
	%tmp166 = getelementptr inbounds %struct.Stmt, %struct.Stmt* %v11, i32 0, i32 1
	store i8* %tmp163, i8** %tmp166
	%tmp167 = load %struct.Stmt, %struct.Stmt* %v11
	call void @"vector.push<%struct.Stmt>"(%"struct.vector.Vec<%struct.Stmt>"* %statement_vector, %struct.Stmt %tmp167)
	br label %loop_body1
; Variable stmt is out.
; Variable nodes is out.
endif24:
	%tmp168 = icmp eq i8 %tmp5, 50
	br i1 %tmp168, label %then27, label %endif27
then27:
	store i32 4294967295, i32* %v1
	...
	%tmp174 = icmp ne i8 %tmp173, 65
	br i1 %tmp174, label %then28, label %endif28
then28:
...
endif28:
	...
	%tmp177 = getelementptr inbounds %struct.TokenData, %struct.TokenData* %tmp176, i32 0, i32 1
	%tmp178 = load i16, i16* %tmp177
	%tmp179 = load i32, i32* %v0
	%tmp180 = add i32 %tmp179, 1
	store i32 %tmp180, i32* %v0
	store %struct.Type* null, %struct.Type** %v12
	...
	%tmp184 = icmp eq i8 %tmp183, 6
	br i1 %tmp184, label %then29, label %endif29
then29:
	%tmp185 = load i32, i32* %v0
	%tmp186 = add i32 %tmp185, 1
	store i32 %tmp186, i32* %v0
	%tmp187 = call %struct.Type @parse_type(%struct.TokenData* %token_array, i32* %v0, i32 %token_len)
	%tmp188 = call i8* @mem.malloc(i64 16)
	store %struct.Type* %tmp188, %struct.Type** %v12
	%tmp189 = load %struct.Type*, %struct.Type** %v12
	store %struct.Type %tmp187, %struct.Type* %tmp189
; Variable parsed_type is out.
	br label %endif29
endif29:
	%tmp190 = call %"struct.vector.Vec<%struct.EnumField>" @"vector.new<%struct.EnumField>"()
	store %"struct.vector.Vec<%struct.EnumField>" %tmp190, %"struct.vector.Vec<%struct.EnumField>"* %v13
	%tmp191 = load i32, i32* %v0
	%tmp192 = getelementptr inbounds %struct.TokenData, %struct.TokenData* %token_array, i32 %tmp191
	%tmp193 = load i8, i8* %tmp192
	%tmp194 = icmp eq i8 %tmp193, 2
	br i1 %tmp194, label %then30, label %else30
then30:
	%tmp195 = call %"struct.vector.Vec<%struct.EnumField>" @parse_enum_fields(%struct.TokenData* %token_array, i32* %v0, i32 %token_len)
	store %"struct.vector.Vec<%struct.EnumField>" %tmp195, %"struct.vector.Vec<%struct.EnumField>"* %v13
	br label %endif30
else30:
	call void @process.throw(i8* @.str.15)
	br label %endif30
endif30:
	%tmp196 = call i8* @mem.malloc(i64 32)
	store i16 %tmp178, i16* %tmp196
	%tmp197 = getelementptr inbounds %struct.EnumNode, %struct.EnumNode* %tmp196, i32 0, i32 1
	%tmp198 = load %struct.Type*, %struct.Type** %v12
	store %struct.Type* %tmp198, %struct.Type** %tmp197
	%tmp199 = getelementptr inbounds %struct.EnumNode, %struct.EnumNode* %tmp196, i32 0, i32 2
	%tmp200 = load %"struct.vector.Vec<%struct.EnumField>", %"struct.vector.Vec<%struct.EnumField>"* %v13
	store %"struct.vector.Vec<%struct.EnumField>" %tmp200, %"struct.vector.Vec<%struct.EnumField>"* %tmp199
	store i8 13, i8* %v14
	%tmp201 = getelementptr inbounds %struct.Stmt, %struct.Stmt* %v14, i32 0, i32 1
	store i8* %tmp196, i8** %tmp201
	%tmp202 = load %struct.Stmt, %struct.Stmt* %v14
	call void @"vector.push<%struct.Stmt>"(%"struct.vector.Vec<%struct.Stmt>"* %statement_vector, %struct.Stmt %tmp202)
	br label %loop_body1
; Variable stmt is out.
; Variable fields is out.
endif27:
	%tmp203 = icmp eq i8 %tmp5, 49
...
endif32:
	...
	%tmp211 = getelementptr inbounds %struct.TokenData, %struct.TokenData* %token_array, i32 %tmp210
	%tmp212 = getelementptr inbounds %struct.TokenData, %struct.TokenData* %tmp211, i32 0, i32 1
	%tmp213 = load i16, i16* %tmp212
	%tmp214 = load i32, i32* %v0
	%tmp215 = add i32 %tmp214, 1
	store i32 %tmp215, i32* %v0
	%tmp216 = call %"struct.vector.Vec<i16>" @"vector.new<i16>"()
	store %"struct.vector.Vec<i16>" %tmp216, %"struct.vector.Vec<i16>"* %v15
	%tmp217 = load i32, i32* %v0
	%tmp218 = getelementptr inbounds %struct.TokenData, %struct.TokenData* %token_array, i32 %tmp217
	%tmp219 = load i8, i8* %tmp218
	%tmp220 = icmp eq i8 %tmp219, 28
	br i1 %tmp220, label %then33, label %endif33
then33:
	%tmp221 = call %"struct.vector.Vec<i16>" @parse_generic_params(%struct.TokenData* %token_array, i32* %v0, i32 %token_len)
	store %"struct.vector.Vec<i16>" %tmp221, %"struct.vector.Vec<i16>"* %v15
	br label %endif33
endif33:
	%tmp222 = call %"struct.vector.Vec<%struct.Argument>" @"vector.new<%struct.Argument>"()
	store %"struct.vector.Vec<%struct.Argument>" %tmp222, %"struct.vector.Vec<%struct.Argument>"* %v16
	%tmp223 = load i32, i32* %v0
	%tmp224 = getelementptr inbounds %struct.TokenData, %struct.TokenData* %token_array, i32 %tmp223
	%tmp225 = load i8, i8* %tmp224
	%tmp226 = icmp eq i8 %tmp225, 2
	br i1 %tmp226, label %then34, label %else34
then34:
	%tmp227 = call %"struct.vector.Vec<%struct.Argument>" @parse_struct_fields(%struct.TokenData* %token_array, i32* %v0, i32 %token_len)
	store %"struct.vector.Vec<%struct.Argument>" %tmp227, %"struct.vector.Vec<%struct.Argument>"* %v16
	br label %endif34
else34:
	call void @process.throw(i8* @.str.17)
	br label %endif34
endif34:
	%tmp228 = call i8* @mem.malloc(i64 40)
	store i16 %tmp213, i16* %tmp228
	%tmp229 = getelementptr inbounds %struct.StructNode, %struct.StructNode* %tmp228, i32 0, i32 1
	%tmp230 = load %"struct.vector.Vec<%struct.Argument>", %"struct.vector.Vec<%struct.Argument>"* %v16
	store %"struct.vector.Vec<%struct.Argument>" %tmp230, %"struct.vector.Vec<%struct.Argument>"* %tmp229
	%tmp231 = getelementptr inbounds %struct.StructNode, %struct.StructNode* %tmp228, i32 0, i32 2
	%tmp232 = load %"struct.vector.Vec<i16>", %"struct.vector.Vec<i16>"* %v15
	store %"struct.vector.Vec<i16>" %tmp232, %"struct.vector.Vec<i16>"* %tmp231
	store i8 12, i8* %v17
	%tmp233 = getelementptr inbounds %struct.Stmt, %struct.Stmt* %v17, i32 0, i32 1
	store i8* %tmp228, i8** %tmp233
	%tmp234 = load %struct.Stmt, %struct.Stmt* %v17
	call void @"vector.push<%struct.Stmt>"(%"struct.vector.Vec<%struct.Stmt>"* %statement_vector, %struct.Stmt %tmp234)
	br label %loop_body1
; Variable stmt is out.
; Variable fields is out.
...
endif31:
	...
	br i1 %tmp238, label %then35, label %endif35
then35:
	%tmp239 = load i32, i32* %v0
	call void @skip_nested(%struct.TokenData* %token_array, i32* %v0, i32 %token_len, i8 2, i8 3)
	%tmp240 = call %"struct.vector.Vec<%struct.Stmt>" @"vector.new<%struct.Stmt>"()
	store %"struct.vector.Vec<%struct.Stmt>" %tmp240, %"struct.vector.Vec<%struct.Stmt>"* %v18
	%tmp241 = load i32, i32* %v0
	%tmp242 = sub i32 %tmp241, 1
	%tmp243 = add i32 %tmp239, 1
	%tmp244 = sub i32 %tmp242, %tmp243
	%tmp245 = getelementptr inbounds %struct.TokenData, %struct.TokenData* %token_array, i32 %tmp239
	%tmp246 = getelementptr inbounds %struct.TokenData, %struct.TokenData* %tmp245, i32 1
	call void @parse(%struct.TokenData* %tmp246, i32 %tmp244, %"struct.vector.Vec<%struct.string.String>"* %symbol_vector, %"struct.vector.Vec<%struct.Stmt>"* %v18)
	%tmp247 = getelementptr inbounds %"struct.vector.Vec<%struct.Stmt>", %"struct.vector.Vec<%struct.Stmt>"* %v18, i32 0, i32 1
	%tmp248 = load i32, i32* %tmp247
	store i32 0, i32* %v19
	br label %loop_cond36
loop_cond36:
	%tmp249 = load i32, i32* %v19
	%tmp250 = getelementptr inbounds %"struct.vector.Vec<%struct.Stmt>", %"struct.vector.Vec<%struct.Stmt>"* %v18, i32 0, i32 1
	%tmp251 = load i32, i32* %tmp250
	%tmp252 = icmp uge i32 %tmp249, %tmp251
	br i1 %tmp252, label %then37, label %endif37
then37:
	br label %loop_body36_exit
endif37:
	%tmp253 = load i32, i32* %v19
	%tmp254 = load %struct.Stmt*, %struct.Stmt** %v18
	%tmp255 = getelementptr inbounds %struct.Stmt, %struct.Stmt* %tmp254, i32 %tmp253
	%tmp256 = load %struct.Stmt, %struct.Stmt* %tmp255
	call void @"vector.push<%struct.Stmt>"(%"struct.vector.Vec<%struct.Stmt>"* %statement_vector, %struct.Stmt %tmp256)
	%tmp257 = load i32, i32* %v19
	%tmp258 = add i32 %tmp257, 1
	store i32 %tmp258, i32* %v19
	br label %loop_cond36
loop_body36_exit:
	br label %loop_body1
; Variable m is out.
endif35:
	%tmp259 = load i32, i32* %v1
	%tmp260 = icmp ne i32 %tmp259, 4294967295
	br i1 %tmp260, label %then38, label %endif38
then38:
	%tmp261 = load i32, i32* %v0
	%tmp262 = sub i32 %tmp261, 1
	%tmp263 = getelementptr inbounds %struct.TokenData, %struct.TokenData* %token_array, i32 %tmp262
	%tmp264 = load i8, i8* %tmp263
	%tmp265 = icmp eq i8 %tmp264, 38
	br i1 %tmp265, label %logic_end_39, label %logic_rhs_39
logic_rhs_39:
	%tmp266 = load i32, i32* %v0
	%tmp267 = sub i32 %tmp266, 1
	%tmp268 = getelementptr inbounds %struct.TokenData, %struct.TokenData* %token_array, i32 %tmp267
	%tmp269 = load i8, i8* %tmp268
	%tmp270 = icmp eq i8 %tmp269, 43
	br label %logic_end_39
logic_end_39:
	%tmp271 = phi i1 [%tmp265, %then38], [%tmp270, %logic_rhs_39]
	br i1 %tmp271, label %then40, label %endif40
then40:
	...
	%tmp275 = icmp ne i8 %tmp274, 65
	br i1 %tmp275, label %then41, label %endif41
then41:
...
endif41:
	...
	%tmp278 = getelementptr inbounds %struct.TokenData, %struct.TokenData* %tmp277, i32 0, i32 1
	%tmp279 = load i16, i16* %tmp278
	%tmp280 = load i32, i32* %v0
	%tmp281 = add i32 %tmp280, 1
	store i32 %tmp281, i32* %v0
	%tmp282 = load i32, i32* %v0
	%tmp283 = getelementptr inbounds %struct.TokenData, %struct.TokenData* %token_array, i32 %tmp282
	%tmp284 = load i8, i8* %tmp283
	%tmp285 = icmp eq i8 %tmp284, 6
	br i1 %tmp285, label %then42, label %else42
then42:
	%tmp286 = load i32, i32* %v0
	%tmp287 = add i32 %tmp286, 1
	store i32 %tmp287, i32* %v0
	%tmp288 = call %struct.Type @parse_type(%struct.TokenData* %token_array, i32* %v0, i32 %token_len)
	%tmp289 = call i8* @mem.malloc(i64 16)
	store %struct.Type* %tmp289, %struct.Type** %v20
	%tmp290 = load %struct.Type*, %struct.Type** %v20
	store %struct.Type %tmp288, %struct.Type* %tmp290
; Variable parsed_type is out.
	br label %endif42
else42:
...
endif42:
	...
	%tmp294 = icmp eq i8 %tmp293, 15
	br i1 %tmp294, label %then43, label %else43
then43:
	...
	br label %endif43
else43:
	%tmp297 = load i32, i32* %v0
	%tmp298 = getelementptr inbounds %struct.TokenData, %struct.TokenData* %token_array, i32 %tmp297
	%tmp299 = load i8, i8* %tmp298
	%tmp300 = icmp eq i8 %tmp299, 8
	br i1 %tmp300, label %endif44, label %else44
else44:
...
endif38:
	store i32 0, i32* %v21
	br label %loop_cond46
loop_cond46:
	%tmp307 = load i32, i32* %v21
	%tmp308 = icmp uge i32 %tmp307, 3
	br i1 %tmp308, label %then47, label %endif47
then47:
	br label %loop_body46_exit
endif47:
	%tmp309 = load i32, i32* %v0
	%tmp310 = load i32, i32* %v21
	%tmp311 = add i32 %tmp309, %tmp310
	%tmp312 = getelementptr inbounds %struct.TokenData, %struct.TokenData* %token_array, i32 %tmp311
	%tmp313 = call %struct.string.String @token_type_to_string(%struct.TokenData* %tmp312, %"struct.vector.Vec<%struct.string.String>"* null)
	store %struct.string.String %tmp313, %struct.string.String* %v22
	call void @console.write_string(%struct.string.String* %v22)
	call void @console.write(i8* @.str.22, i32 6)
	call void @string.free(%struct.string.String* %v22)
	%tmp314 = load i32, i32* %v21
	%tmp315 = add i32 %tmp314, 1
	store i32 %tmp315, i32* %v21
	br label %loop_cond46
loop_body46_exit:
; Variable q is out.
...
endif114:
	call void @console.write(i8* @.str.24, i32 8)
...
then5:
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.26, i32 2)
	br label %endif5
endif5:
...
else2:
	%tmp42 = load i8, i8* %v2
	%tmp43 = icmp eq i8 %tmp42, 20
	br i1 %tmp43, label %then6, label %else6
then6:
	%tmp44 = getelementptr inbounds %struct.Stmt, %struct.Stmt* %v2, i32 0, i32 1
	%tmp45 = load i8*, i8** %tmp44
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.27, i32 2)
	%tmp46 = load i16, i16* %tmp45
	%tmp47 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp2, i16 %tmp46
	%tmp48 = load i8*, i8** %tmp47
	%tmp49 = load i16, i16* %tmp45
	%tmp50 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp2, i16 %tmp49
	%tmp51 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp50, i32 0, i32 1
	%tmp52 = load i32, i32* %tmp51
	call void @string.append_str(%struct.string.String* %stdout, i8* %tmp48, i32 %tmp52)
	call void @string.append(%struct.string.String* %stdout, i8 40)
	%tmp53 = getelementptr inbounds %struct.HintNode, %struct.HintNode* %tmp45, i32 0, i32 1
	%tmp54 = getelementptr inbounds %"struct.vector.Vec<%struct.Expression>", %"struct.vector.Vec<%struct.Expression>"* %tmp53, i32 0, i32 1
	%tmp55 = load i32, i32* %tmp54
	store i32 0, i32* %v4
	br label %loop_cond7
loop_cond7:
	%tmp56 = load i32, i32* %v4
	%tmp57 = getelementptr inbounds %struct.HintNode, %struct.HintNode* %tmp45, i32 0, i32 1
	...
	%tmp60 = icmp uge i32 %tmp56, %tmp59
	br i1 %tmp60, label %then8, label %endif8
then8:
	br label %loop_body7_exit
endif8:
	%tmp62 = load i32, i32* %v4
	%tmp63 = getelementptr inbounds %struct.HintNode, %struct.HintNode* %tmp45, i32 0, i32 1
	%tmp64 = load %struct.Expression*, %struct.Expression** %tmp63
	%tmp65 = getelementptr inbounds %struct.Expression, %struct.Expression* %tmp64, i32 %tmp62
	...
	%tmp67 = getelementptr inbounds %struct.HintNode, %struct.HintNode* %tmp45, i32 0, i32 1
	...
	%tmp71 = icmp ne i32 %tmp66, %tmp70
	br i1 %tmp71, label %then9, label %endif9
then9:
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.26, i32 2)
	br label %endif9
endif9:
...
loop_body7_exit:
	call void @string.append(%struct.string.String* %stdout, i8 41)
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.28, i32 2)
	br label %endif6
else6:
	%tmp74 = load i8, i8* %v2
	%tmp75 = icmp eq i8 %tmp74, 11
	br i1 %tmp75, label %then10, label %else10
then10:
	%tmp76 = getelementptr inbounds %struct.Stmt, %struct.Stmt* %v2, i32 0, i32 1
	%tmp77 = load i8*, i8** %tmp76
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.29, i32 3)
	%tmp78 = load i16, i16* %tmp77
	%tmp79 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp2, i16 %tmp78
	%tmp80 = load i8*, i8** %tmp79
	%tmp81 = load i16, i16* %tmp77
	%tmp82 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp2, i16 %tmp81
	%tmp83 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp82, i32 0, i32 1
	%tmp84 = load i32, i32* %tmp83
	call void @string.append_str(%struct.string.String* %stdout, i8* %tmp80, i32 %tmp84)
	call void @string.append(%struct.string.String* %stdout, i8 40)
	%tmp85 = getelementptr inbounds %struct.FnNode, %struct.FnNode* %tmp77, i32 0, i32 1
	%tmp86 = getelementptr inbounds %"struct.vector.Vec<%struct.Argument>", %"struct.vector.Vec<%struct.Argument>"* %tmp85, i32 0, i32 1
	%tmp87 = load i32, i32* %tmp86
	store i32 0, i32* %v5
	br label %loop_cond11
loop_cond11:
	%tmp88 = load i32, i32* %v5
	%tmp89 = getelementptr inbounds %struct.FnNode, %struct.FnNode* %tmp77, i32 0, i32 1
	...
	%tmp92 = icmp uge i32 %tmp88, %tmp91
	br i1 %tmp92, label %then12, label %endif12
then12:
	br label %loop_body11_exit
endif12:
	%tmp94 = load i32, i32* %v5
	%tmp95 = getelementptr inbounds %struct.FnNode, %struct.FnNode* %tmp77, i32 0, i32 1
	%tmp96 = load %struct.Argument*, %struct.Argument** %tmp95
	%tmp97 = getelementptr inbounds %struct.Argument, %struct.Argument* %tmp96, i32 %tmp94
	%tmp98 = load i16, i16* %tmp97
	%tmp99 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp2, i16 %tmp98
	%tmp100 = load i8*, i8** %tmp99
	%tmp101 = load i16, i16* %tmp97
	%tmp102 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp2, i16 %tmp101
	%tmp103 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp102, i32 0, i32 1
	%tmp104 = load i32, i32* %tmp103
	call void @string.append_str(%struct.string.String* %stdout, i8* %tmp100, i32 %tmp104)
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.30, i32 2)
	%tmp105 = getelementptr inbounds %struct.Argument, %struct.Argument* %tmp97, i32 0, i32 1
	call void @debug_dump_type(%struct.Type* %tmp105, %"struct.vector.Vec<%struct.string.String>"* %symbol_vector, %struct.string.String* %stdout)
	%tmp106 = load i32, i32* %v5
	%tmp107 = getelementptr inbounds %struct.FnNode, %struct.FnNode* %tmp77, i32 0, i32 1
	%tmp108 = getelementptr inbounds %"struct.vector.Vec<%struct.Argument>", %"struct.vector.Vec<%struct.Argument>"* %tmp107, i32 0, i32 1
	%tmp109 = load i32, i32* %tmp108
	%tmp110 = sub i32 %tmp109, 1
	%tmp111 = icmp ne i32 %tmp106, %tmp110
...
endif13:
	...
	store i32 %tmp113, i32* %v5
	br label %loop_cond11
loop_body11_exit:
	call void @string.append(%struct.string.String* %stdout, i8 41)
	%tmp114 = getelementptr inbounds %struct.FnNode, %struct.FnNode* %tmp77, i32 0, i32 4
	%tmp115 = getelementptr inbounds %"struct.vector.Vec<%struct.Stmt>", %"struct.vector.Vec<%struct.Stmt>"* %tmp114, i32 0, i32 1
	%tmp116 = load i32, i32* %tmp115
	%tmp117 = icmp ne i32 %tmp116, 0
	br i1 %tmp117, label %then14, label %endif14
then14:
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.31, i32 2)
	%tmp118 = getelementptr inbounds %struct.FnNode, %struct.FnNode* %tmp77, i32 0, i32 4
	call void @compile_body(%"struct.vector.Vec<%struct.Stmt>"* %tmp118, %"struct.vector.Vec<%struct.string.String>"* %symbol_vector, %struct.string.String* %stdout)
...
endif14:
	...
	br label %endif10
else10:
	%tmp119 = load i8, i8* %v2
	%tmp120 = icmp eq i8 %tmp119, 12
	br i1 %tmp120, label %then15, label %else15
then15:
	%tmp121 = getelementptr inbounds %struct.Stmt, %struct.Stmt* %v2, i32 0, i32 1
	%tmp122 = load i8*, i8** %tmp121
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.32, i32 7)
	%tmp123 = load i16, i16* %tmp122
	%tmp124 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp2, i16 %tmp123
	%tmp125 = load i8*, i8** %tmp124
	%tmp126 = load i16, i16* %tmp122
	%tmp127 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp2, i16 %tmp126
	%tmp128 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp127, i32 0, i32 1
	%tmp129 = load i32, i32* %tmp128
	call void @string.append_str(%struct.string.String* %stdout, i8* %tmp125, i32 %tmp129)
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.31, i32 2)
	%tmp130 = getelementptr inbounds %struct.StructNode, %struct.StructNode* %tmp122, i32 0, i32 1
	%tmp131 = getelementptr inbounds %"struct.vector.Vec<%struct.Argument>", %"struct.vector.Vec<%struct.Argument>"* %tmp130, i32 0, i32 1
	%tmp132 = load i32, i32* %tmp131
	store i32 0, i32* %v6
	br label %loop_cond16
loop_cond16:
	%tmp133 = load i32, i32* %v6
	%tmp134 = getelementptr inbounds %struct.StructNode, %struct.StructNode* %tmp122, i32 0, i32 1
	%tmp135 = getelementptr inbounds %"struct.vector.Vec<%struct.Argument>", %"struct.vector.Vec<%struct.Argument>"* %tmp134, i32 0, i32 1
	%tmp136 = load i32, i32* %tmp135
	%tmp137 = icmp uge i32 %tmp133, %tmp136
	br i1 %tmp137, label %then17, label %endif17
then17:
	br label %loop_body16_exit
endif17:
	%tmp139 = load i32, i32* %v6
	%tmp140 = getelementptr inbounds %struct.StructNode, %struct.StructNode* %tmp122, i32 0, i32 1
	%tmp141 = load %struct.Argument*, %struct.Argument** %tmp140
	%tmp142 = getelementptr inbounds %struct.Argument, %struct.Argument* %tmp141, i32 %tmp139
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.33, i32 1)
	%tmp143 = load i16, i16* %tmp142
	%tmp144 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp2, i16 %tmp143
	%tmp145 = load i8*, i8** %tmp144
	%tmp146 = load i16, i16* %tmp142
	%tmp147 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp2, i16 %tmp146
	%tmp148 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp147, i32 0, i32 1
	%tmp149 = load i32, i32* %tmp148
	call void @string.append_str(%struct.string.String* %stdout, i8* %tmp145, i32 %tmp149)
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.30, i32 2)
	%tmp150 = getelementptr inbounds %struct.Argument, %struct.Argument* %tmp142, i32 0, i32 1
	call void @debug_dump_type(%struct.Type* %tmp150, %"struct.vector.Vec<%struct.string.String>"* %symbol_vector, %struct.string.String* %stdout)
	call void @string.append(%struct.string.String* %stdout, i8 10)
	...
	br label %loop_cond16
loop_body16_exit:
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.34, i32 2)
	br label %endif15
else15:
	%tmp153 = load i8, i8* %v2
	%tmp154 = icmp eq i8 %tmp153, 13
	br i1 %tmp154, label %then18, label %else18
then18:
	%tmp155 = getelementptr inbounds %struct.Stmt, %struct.Stmt* %v2, i32 0, i32 1
	%tmp156 = load i8*, i8** %tmp155
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.35, i32 5)
	%tmp157 = load i16, i16* %tmp156
	%tmp158 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp2, i16 %tmp157
	%tmp159 = load i8*, i8** %tmp158
	%tmp160 = load i16, i16* %tmp156
	%tmp161 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp2, i16 %tmp160
	%tmp162 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp161, i32 0, i32 1
	%tmp163 = load i32, i32* %tmp162
	call void @string.append_str(%struct.string.String* %stdout, i8* %tmp159, i32 %tmp163)
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.31, i32 2)
	%tmp164 = getelementptr inbounds %struct.EnumNode, %struct.EnumNode* %tmp156, i32 0, i32 2
	%tmp165 = getelementptr inbounds %"struct.vector.Vec<%struct.EnumField>", %"struct.vector.Vec<%struct.EnumField>"* %tmp164, i32 0, i32 1
	%tmp166 = load i32, i32* %tmp165
	store i32 0, i32* %v7
	br label %loop_cond19
loop_cond19:
	%tmp167 = load i32, i32* %v7
	%tmp168 = getelementptr inbounds %struct.EnumNode, %struct.EnumNode* %tmp156, i32 0, i32 2
	%tmp169 = getelementptr inbounds %"struct.vector.Vec<%struct.EnumField>", %"struct.vector.Vec<%struct.EnumField>"* %tmp168, i32 0, i32 1
	%tmp170 = load i32, i32* %tmp169
	%tmp171 = icmp uge i32 %tmp167, %tmp170
	br i1 %tmp171, label %then20, label %endif20
then20:
	br label %loop_body19_exit
endif20:
	%tmp173 = load i32, i32* %v7
	%tmp174 = getelementptr inbounds %struct.EnumNode, %struct.EnumNode* %tmp156, i32 0, i32 2
	%tmp175 = load %struct.EnumField*, %struct.EnumField** %tmp174
	%tmp176 = getelementptr inbounds %struct.EnumField, %struct.EnumField* %tmp175, i32 %tmp173
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.33, i32 1)
	%tmp177 = load i16, i16* %tmp176
	%tmp178 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp2, i16 %tmp177
	%tmp179 = load i8*, i8** %tmp178
	%tmp180 = load i16, i16* %tmp176
	%tmp181 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp2, i16 %tmp180
	%tmp182 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp181, i32 0, i32 1
	%tmp183 = load i32, i32* %tmp182
	call void @string.append_str(%struct.string.String* %stdout, i8* %tmp179, i32 %tmp183)
	%tmp184 = getelementptr inbounds %struct.EnumField, %struct.EnumField* %tmp176, i32 0, i32 1
	%tmp185 = load i1, i1* %tmp184
	br i1 %tmp185, label %then21, label %endif21
then21:
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.30, i32 2)
	br label %endif21
endif21:
	...
	store i32 %tmp187, i32* %v7
	br label %loop_cond19
loop_body19_exit:
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.34, i32 2)
	br label %endif18
else18:
	%tmp188 = load i8, i8* %v2
	%tmp189 = icmp eq i8 %tmp188, 14
	br i1 %tmp189, label %then22, label %else22
then22:
	%tmp190 = getelementptr inbounds %struct.Stmt, %struct.Stmt* %v2, i32 0, i32 1
	%tmp191 = load i8*, i8** %tmp190
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.36, i32 10)
	%tmp192 = load i16, i16* %tmp191
	%tmp193 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp2, i16 %tmp192
	%tmp194 = load i8*, i8** %tmp193
	%tmp195 = load i16, i16* %tmp191
	%tmp196 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp2, i16 %tmp195
	%tmp197 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp196, i32 0, i32 1
	%tmp198 = load i32, i32* %tmp197
	call void @string.append_str(%struct.string.String* %stdout, i8* %tmp194, i32 %tmp198)
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.31, i32 2)
	%tmp199 = getelementptr inbounds %struct.NamespaceNode, %struct.NamespaceNode* %tmp191, i32 0, i32 1
	call void @compile(%"struct.vector.Vec<%struct.Stmt>"* %tmp199, %"struct.vector.Vec<%struct.string.String>"* %symbol_vector, %struct.string.String* %stdout)
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.34, i32 2)
	br label %endif22
else22:
	%tmp200 = load i8, i8* %v2
	%tmp201 = icmp eq i8 %tmp200, 1
	br i1 %tmp201, label %then23, label %else23
then23:
	%tmp202 = getelementptr inbounds %struct.Stmt, %struct.Stmt* %v2, i32 0, i32 1
	%tmp203 = load i8*, i8** %tmp202
	%tmp204 = getelementptr inbounds %struct.DeclarationNode, %struct.DeclarationNode* %tmp203, i32 0, i32 4
	%tmp205 = load i8, i8* %tmp204
	%tmp206 = icmp eq i8 %tmp205, 2
	br i1 %tmp206, label %then24, label %else24
then24:
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.37, i32 7)
	br label %endif24
else24:
	%tmp207 = getelementptr inbounds %struct.DeclarationNode, %struct.DeclarationNode* %tmp203, i32 0, i32 4
	%tmp208 = load i8, i8* %tmp207
	%tmp209 = icmp eq i8 %tmp208, 1
	br i1 %tmp209, label %then25, label %else25
then25:
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.38, i32 8)
	br label %endif25
else25:
	%tmp210 = getelementptr inbounds %struct.DeclarationNode, %struct.DeclarationNode* %tmp203, i32 0, i32 4
	%tmp211 = load i8, i8* %tmp210
	%tmp212 = icmp eq i8 %tmp211, 0
	br i1 %tmp212, label %then26, label %endif26
then26:
...
endif25:
	br label %endif24
endif24:
	%tmp213 = load i16, i16* %tmp203
	%tmp214 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp2, i16 %tmp213
	%tmp215 = load i8*, i8** %tmp214
	%tmp216 = load i16, i16* %tmp203
	%tmp217 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp2, i16 %tmp216
	%tmp218 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp217, i32 0, i32 1
	%tmp219 = load i32, i32* %tmp218
	call void @string.append_str(%struct.string.String* %stdout, i8* %tmp215, i32 %tmp219)
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.40, i32 3)
	%tmp220 = getelementptr inbounds %struct.DeclarationNode, %struct.DeclarationNode* %tmp203, i32 0, i32 3
	call void @debug_dump_type(%struct.Type* %tmp220, %"struct.vector.Vec<%struct.string.String>"* %symbol_vector, %struct.string.String* %stdout)
	%tmp221 = getelementptr inbounds %struct.DeclarationNode, %struct.DeclarationNode* %tmp203, i32 0, i32 1
	%tmp222 = load i1, i1* %tmp221
	br i1 %tmp222, label %then27, label %endif27
then27:
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.41, i32 3)
	%tmp223 = getelementptr inbounds %struct.DeclarationNode, %struct.DeclarationNode* %tmp203, i32 0, i32 2
	call void @debug_dump_expression(%struct.Expression* %tmp223, %"struct.vector.Vec<%struct.string.String>"* %symbol_vector, %struct.string.String* %stdout)
	br label %endif27
endif27:
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.42, i32 2)
	br label %endif23
else23:
	store i32 0, i32* %v8
	br label %loop_cond28
loop_cond28:
	%tmp224 = load i32, i32* %v8
	%tmp225 = icmp uge i32 %tmp224, 3
	br i1 %tmp225, label %then29, label %endif29
then29:
	br label %loop_body28_exit
endif29:
	%tmp226 = load i32, i32* %v0
	%tmp227 = load i32, i32* %v8
	%tmp228 = add i32 %tmp226, %tmp227
	%tmp229 = load %struct.Stmt*, %struct.Stmt** %statement_vector
	%tmp230 = getelementptr inbounds %struct.Stmt, %struct.Stmt* %tmp229, i32 %tmp228
	%tmp231 = load i8, i8* %tmp230
	%tmp232 = zext i8 %tmp231 to i64
	call void @console.println_i64(i64 %tmp232)
	call void @console.write(i8* @.str.22, i32 6)
	%tmp233 = load i32, i32* %v8
	%tmp234 = add i32 %tmp233, 1
	store i32 %tmp234, i32* %v8
	br label %loop_cond28
loop_body28_exit:
...
define void @process.throw(i8* %exception){
	...
	call void @console.writeln(i8* @.str.44, i32 11)
...
then0:
	call void @console.write(i8* @.str.46, i32 2)
	br label %func_exit
endif0:
	store i64 %n, i64* %v1
	br label %loop_start1
...
then5:
	%tmp31 = call %struct.string.String @string.from_c_string(i8* @.str.48)
	br label %func_exit
endif5:
	br label %endif0
else0:
...
then6:
	%tmp34 = call %struct.string.String @string.from_c_string(i8* @.str.49)
	br label %func_exit
else6:
...
then7:
	%tmp37 = call %struct.string.String @string.from_c_string(i8* @.str.50)
	br label %func_exit
else7:
...
then8:
	%tmp40 = call %struct.string.String @string.from_c_string(i8* @.str.51)
	br label %func_exit
else8:
...
then9:
	%tmp43 = call %struct.string.String @string.from_c_string(i8* @.str.52)
	br label %func_exit
else9:
...
then10:
	%tmp46 = call %struct.string.String @string.from_c_string(i8* @.str.48)
	br label %func_exit
endif10:
	br label %endif0
endif0:
...
then11:
	%tmp49 = call %struct.string.String @string.from_c_string(i8* @.str.53)
	br label %func_exit
else11:
...
then12:
	%tmp52 = call %struct.string.String @string.from_c_string(i8* @.str.54)
	br label %func_exit
else12:
...
then13:
	%tmp55 = call %struct.string.String @string.from_c_string(i8* @.str.55)
	br label %func_exit
else13:
...
then14:
	%tmp58 = call %struct.string.String @string.from_c_string(i8* @.str.56)
	br label %func_exit
else14:
...
then15:
	%tmp61 = call %struct.string.String @string.from_c_string(i8* @.str.57)
	br label %func_exit
else15:
...
then16:
	%tmp64 = call %struct.string.String @string.from_c_string(i8* @.str.58)
	br label %func_exit
else16:
...
then17:
	%tmp67 = call %struct.string.String @string.from_c_string(i8* @.str.59)
	br label %func_exit
else17:
...
then18:
	%tmp70 = call %struct.string.String @string.from_c_string(i8* @.str.60)
	br label %func_exit
else18:
...
then19:
	%tmp73 = call %struct.string.String @string.from_c_string(i8* @.str.61)
	br label %func_exit
else19:
...
then20:
	%tmp76 = call %struct.string.String @string.from_c_string(i8* @.str.62)
	br label %func_exit
else20:
...
then21:
	%tmp79 = call %struct.string.String @string.from_c_string(i8* @.str.63)
	br label %func_exit
else21:
...
then22:
	%tmp82 = call %struct.string.String @string.from_c_string(i8* @.str.64)
	br label %func_exit
else22:
...
then23:
	%tmp85 = call %struct.string.String @string.from_c_string(i8* @.str.65)
	br label %func_exit
else23:
...
then24:
	%tmp88 = call %struct.string.String @string.from_c_string(i8* @.str.66)
	br label %func_exit
else24:
...
then25:
	%tmp91 = call %struct.string.String @string.from_c_string(i8* @.str.67)
	br label %func_exit
else25:
...
then26:
	%tmp94 = call %struct.string.String @string.from_c_string(i8* @.str.68)
	br label %func_exit
else26:
...
then27:
	%tmp97 = call %struct.string.String @string.from_c_string(i8* @.str.69)
	br label %func_exit
else27:
...
then28:
	%tmp100 = call %struct.string.String @string.from_c_string(i8* @.str.70)
	br label %func_exit
else28:
...
then29:
	%tmp103 = call %struct.string.String @string.from_c_string(i8* @.str.71)
	br label %func_exit
else29:
...
then30:
	%tmp106 = call %struct.string.String @string.from_c_string(i8* @.str.72)
	br label %func_exit
else30:
...
then31:
	%tmp109 = call %struct.string.String @string.from_c_string(i8* @.str.73)
	br label %func_exit
else31:
...
then32:
	%tmp112 = call %struct.string.String @string.from_c_string(i8* @.str.74)
	br label %func_exit
else32:
...
then33:
	%tmp115 = call %struct.string.String @string.from_c_string(i8* @.str.75)
	br label %func_exit
else33:
...
then34:
	%tmp118 = call %struct.string.String @string.from_c_string(i8* @.str.76)
	br label %func_exit
else34:
...
then35:
	%tmp121 = call %struct.string.String @string.from_c_string(i8* @.str.77)
	br label %func_exit
else35:
...
then36:
	%tmp124 = call %struct.string.String @string.from_c_string(i8* @.str.78)
	br label %func_exit
else36:
...
then37:
	%tmp127 = call %struct.string.String @string.from_c_string(i8* @.str.79)
	br label %func_exit
else37:
...
then38:
	%tmp130 = call %struct.string.String @string.from_c_string(i8* @.str.80)
	br label %func_exit
else38:
...
then39:
	%tmp133 = call %struct.string.String @string.from_c_string(i8* @.str.81)
	br label %func_exit
else39:
...
then40:
	%tmp136 = call %struct.string.String @string.from_c_string(i8* @.str.82)
	br label %func_exit
else40:
...
then41:
	%tmp139 = call %struct.string.String @string.from_c_string(i8* @.str.83)
	br label %func_exit
else41:
...
then42:
	%tmp142 = call %struct.string.String @string.from_c_string(i8* @.str.84)
	br label %func_exit
else42:
...
then43:
	%tmp145 = call %struct.string.String @string.from_c_string(i8* @.str.85)
	br label %func_exit
else43:
...
then44:
	%tmp148 = call %struct.string.String @string.from_c_string(i8* @.str.86)
	br label %func_exit
else44:
...
then45:
	%tmp151 = call %struct.string.String @string.from_c_string(i8* @.str.87)
	br label %func_exit
else45:
...
then46:
	%tmp154 = call %struct.string.String @string.from_c_string(i8* @.str.88)
	br label %func_exit
else46:
...
then47:
	%tmp157 = call %struct.string.String @string.from_c_string(i8* @.str.89)
	br label %func_exit
else47:
...
then48:
	%tmp160 = call %struct.string.String @string.from_c_string(i8* @.str.90)
	br label %func_exit
else48:
...
then49:
	%tmp163 = call %struct.string.String @string.from_c_string(i8* @.str.91)
	br label %func_exit
else49:
...
then50:
	%tmp166 = call %struct.string.String @string.from_c_string(i8* @.str.92)
	br label %func_exit
else50:
...
then51:
	%tmp169 = call %struct.string.String @string.from_c_string(i8* @.str.93)
	br label %func_exit
else51:
...
then52:
	%tmp172 = call %struct.string.String @string.from_c_string(i8* @.str.94)
	br label %func_exit
else52:
...
then53:
	%tmp175 = call %struct.string.String @string.from_c_string(i8* @.str.95)
	br label %func_exit
else53:
...
then54:
	%tmp178 = call %struct.string.String @string.from_c_string(i8* @.str.96)
	br label %func_exit
else54:
...
then55:
	%tmp181 = call %struct.string.String @string.from_c_string(i8* @.str.97)
	br label %func_exit
else55:
...
then56:
	%tmp184 = call %struct.string.String @string.from_c_string(i8* @.str.98)
	br label %func_exit
else56:
...
then57:
	%tmp187 = call %struct.string.String @string.from_c_string(i8* @.str.99)
	br label %func_exit
else57:
...
then58:
	%tmp190 = call %struct.string.String @string.from_c_string(i8* @.str.100)
	br label %func_exit
else58:
	...
	br i1 %tmp192, label %then59, label %else59
then59:
	%tmp193 = call %struct.string.String @string.from_c_string(i8* @.str.101)
	br label %func_exit
else59:
...
then60:
	%tmp196 = call %struct.string.String @string.from_c_string(i8* @.str.102)
	br label %func_exit
else60:
...
then61:
	%tmp199 = call %struct.string.String @string.from_c_string(i8* @.str.103)
	br label %func_exit
else61:
...
then62:
	%tmp202 = call %struct.string.String @string.from_c_string(i8* @.str.104)
	br label %func_exit
else62:
	...
	br i1 %tmp204, label %then63, label %else63
then63:
	%tmp205 = call %struct.string.String @string.from_c_string(i8* @.str.105)
	br label %func_exit
else63:
...
then64:
	%tmp208 = call %struct.string.String @string.from_c_string(i8* @.str.106)
	br label %func_exit
else64:
...
then65:
	%tmp211 = call %struct.string.String @string.from_c_string(i8* @.str.107)
	br label %func_exit
else65:
...
then66:
	%tmp214 = call %struct.string.String @string.from_c_string(i8* @.str.108)
	br label %func_exit
else66:
...
then67:
	%tmp217 = call %struct.string.String @string.from_c_string(i8* @.str.109)
	br label %func_exit
else67:
...
then68:
	%tmp220 = call %struct.string.String @string.from_c_string(i8* @.str.110)
	br label %func_exit
else68:
...
then69:
	%tmp223 = call %struct.string.String @string.from_c_string(i8* @.str.111)
	br label %func_exit
else69:
...
then70:
	%tmp226 = call %struct.string.String @string.from_c_string(i8* @.str.112)
	br label %func_exit
else70:
...
then71:
	%tmp229 = call %struct.string.String @string.from_c_string(i8* @.str.113)
	br label %func_exit
else71:
...
then72:
	%tmp232 = call %struct.string.String @string.from_c_string(i8* @.str.114)
	br label %func_exit
else72:
...
then73:
	%tmp235 = call %struct.string.String @string.from_c_string(i8* @.str.115)
	br label %func_exit
endif73:
	br label %endif11
endif11:
	%tmp236 = call %struct.string.String @string.from_c_string(i8* @.str.116)
	br label %func_exit
func_exit:
...
define %"struct.vector.Vec<%struct.Argument>" @parse_struct_fields(%struct.TokenData* %token_array, i32* %index, i32 %len){
	...
	call void @expect(%struct.TokenData* %token_array, i32* %index, i32 %len, i8 2, i8* @.str.17)
	br label %loop_start0
loop_start0:
...
endif3:
	...
	call void @expect(%struct.TokenData* %token_array, i32* %index, i32 %len, i8 6, i8* @.str.118)
...
else4:
	...
	br i1 %tmp30, label %then5, label %endif5
then5:
	call void @process.throw(i8* @.str.119)
	br label %endif5
endif5:
	br label %endif4
endif4:
...
; Variable field is out.
	call void @expect(%struct.TokenData* %token_array, i32* %index, i32 %len, i8 3, i8* @.str.120)
...
then5:
	...
	br label %endif5
else5:
	call void @process.throw(i8* @.str.121)
	br label %endif5
endif5:
	br label %endif4
endif4:
	br label %loop_start1
loop_body1_exit:
	call void @expect(%struct.TokenData* %token_array, i32* %index, i32 %len, i8 26, i8* @.str.122)
	br label %endif0
endif0:
...
endif2:
	...
	br i1 %tmp11, label %then3, label %endif3
then3:
	call void @process.throw(i8* @.str.123)
	br label %endif3
endif3:
	%tmp12 = load i32, i32* %index
	%tmp13 = getelementptr inbounds %struct.TokenData, %struct.TokenData* %token_array, i32 %tmp12
...
then6:
	call void @process.throw(i8* @.str.124)
	br label %endif6
endif6:
	br label %endif5
endif5:
...
loop_body0_exit:
; Variable field is out.
	call void @expect(%struct.TokenData* %token_array, i32* %index, i32 %len, i8 3, i8* @.str.125)
...
endif4:
	...
	call void @expect(%struct.TokenData* %token_array, i32* %v0, i32 %token_len, i8 8, i8* @.str.126)
...
then7:
	...
	call void @expect(%struct.TokenData* %token_array, i32* %v0, i32 %token_len, i8 65, i8* @.str.127)
	call void @expect(%struct.TokenData* %token_array, i32* %v0, i32 %token_len, i8 6, i8* @.str.128)
...
; Variable x is out.
	br label %endif8
endif8:
	call void @expect(%struct.TokenData* %token_array, i32* %v0, i32 %token_len, i8 8, i8* @.str.129)
...
endif21:
	call void @skip_nested(%struct.TokenData* %token_array, i32* %v0, i32 %token_len, i8 2, i8 3)
	call void @expect(%struct.TokenData* %token_array, i32* %v0, i32 %token_len, i8 55, i8* @.str.133)
	...
	call void @expect(%struct.TokenData* %token_array, i32* %v0, i32 %token_len, i8 8, i8* @.str.134)
	br label %loop_body1
; Variable expression is out.
endif20:
...
endif23:
	...
	%tmp115 = add i32 %tmp114, 1
	store i32 %tmp115, i32* %v0
	call void @expect(%struct.TokenData* %token_array, i32* %v0, i32 %token_len, i8 54, i8* @.str.136)
...
then24:
	...
	call void @expect(%struct.TokenData* %token_array, i32* %v0, i32 %token_len, i8 8, i8* @.str.137)
...
endif26:
	...
	call void @console.write(i8* @.str.138, i32 4)
...
then6:
	call void @process.throw(i8* @.str.142)
	br label %endif6
endif6:
	br label %endif5
endif5:
...
then0:
	%tmp3 = call i32 @mem.compare(i8* %tmp1, i8* @.str.143, i64 2)
...
; Variable temp is out.
endif1:
	%tmp8 = call i32 @mem.compare(i8* %tmp1, i8* @.str.144, i64 2)
...
; Variable temp is out.
endif2:
	%tmp13 = call i32 @mem.compare(i8* %tmp1, i8* @.str.145, i64 2)
	%tmp14 = icmp eq i32 %tmp13, 0
...
; Variable temp is out.
endif3:
	%tmp18 = call i32 @mem.compare(i8* %tmp1, i8* @.str.146, i64 2)
...
; Variable temp is out.
endif4:
	%tmp23 = call i32 @mem.compare(i8* %tmp1, i8* @.str.147, i64 2)
...
then6:
	%tmp29 = call i32 @mem.compare(i8* %tmp1, i8* @.str.148, i64 3)
...
; Variable temp is out.
endif7:
	%tmp34 = call i32 @mem.compare(i8* %tmp1, i8* @.str.149, i64 3)
...
; Variable temp is out.
endif8:
	%tmp39 = call i32 @mem.compare(i8* %tmp1, i8* @.str.150, i64 3)
...
then10:
	%tmp45 = call i32 @mem.compare(i8* %tmp1, i8* @.str.151, i64 4)
...
; Variable temp is out.
endif11:
	%tmp50 = call i32 @mem.compare(i8* %tmp1, i8* @.str.152, i64 4)
...
; Variable temp is out.
endif12:
	%tmp55 = call i32 @mem.compare(i8* %tmp1, i8* @.str.153, i64 4)
...
; Variable temp is out.
endif13:
	%tmp60 = call i32 @mem.compare(i8* %tmp1, i8* @.str.154, i64 4)
...
; Variable temp is out.
endif14:
	%tmp65 = call i32 @mem.compare(i8* %tmp1, i8* @.str.155, i64 4)
...
; Variable temp is out.
endif15:
	%tmp70 = call i32 @mem.compare(i8* %tmp1, i8* @.str.156, i64 4)
...
; Variable temp is out.
endif16:
	%tmp75 = call i32 @mem.compare(i8* %tmp1, i8* @.str.157, i64 4)
...
then18:
	%tmp81 = call i32 @mem.compare(i8* %tmp1, i8* @.str.158, i64 5)
...
; Variable temp is out.
endif19:
	%tmp86 = call i32 @mem.compare(i8* %tmp1, i8* @.str.159, i64 5)
...
; Variable temp is out.
endif20:
	%tmp91 = call i32 @mem.compare(i8* %tmp1, i8* @.str.160, i64 5)
...
; Variable temp is out.
endif21:
	%tmp96 = call i32 @mem.compare(i8* %tmp1, i8* @.str.161, i64 5)
...
; Variable temp is out.
endif22:
	%tmp101 = call i32 @mem.compare(i8* %tmp1, i8* @.str.162, i64 5)
...
; Variable temp is out.
endif23:
	%tmp106 = call i32 @mem.compare(i8* %tmp1, i8* @.str.163, i64 5)
...
then25:
	%tmp112 = call i32 @mem.compare(i8* %tmp1, i8* @.str.164, i64 6)
...
; Variable temp is out.
endif26:
	%tmp117 = call i32 @mem.compare(i8* %tmp1, i8* @.str.165, i64 6)
...
; Variable temp is out.
endif27:
	%tmp122 = call i32 @mem.compare(i8* %tmp1, i8* @.str.166, i64 6)
...
; Variable temp is out.
endif28:
	%tmp127 = call i32 @mem.compare(i8* %tmp1, i8* @.str.167, i64 6)
...
; Variable temp is out.
endif29:
	%tmp132 = call i32 @mem.compare(i8* %tmp1, i8* @.str.168, i64 6)
...
then31:
	%tmp138 = call i32 @mem.compare(i8* %tmp1, i8* @.str.169, i64 8)
...
; Variable temp is out.
endif32:
	%tmp143 = call i32 @mem.compare(i8* %tmp1, i8* @.str.170, i64 8)
...
then34:
	%tmp149 = call i32 @mem.compare(i8* %tmp1, i8* @.str.171, i64 9)
...
; Variable q is out.
	...
	call void @console.write(i8* @.str.174, i32 4)
	call void @console.write_string(%struct.string.String* %v2)
	call void @console.write(i8* @.str.175, i32 5)
...
then0:
	...
	%tmp6 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp5, i16 %tmp4
	%tmp7 = load i8*, i8** %tmp6
	%tmp8 = load i16, i16* %tmp3
	%tmp9 = load %struct.string.String*, %struct.string.String** %symbol_vector
	%tmp10 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp9, i16 %tmp8
	%tmp11 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp10, i32 0, i32 1
	%tmp12 = load i32, i32* %tmp11
	call void @string.append_str(%struct.string.String* %stdout, i8* %tmp7, i32 %tmp12)
	call void @string.append(%struct.string.String* %stdout, i8 34)
	br label %endif0
endif0:
	ret void
...
then3:
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.176, i32 7)
	br label %endif3
else3:
...
then4:
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.177, i32 8)
	br label %endif4
else4:
...
then5:
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.178, i32 5)
	br label %endif5
endif5:
	br label %endif4
endif4:
...
then7:
	...
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.179, i32 4)
...
then8:
	...
	call void @string.append_str(%struct.string.String* %stdout, i8* @.str.180, i32 7)
...
then5:
	...
	call void @expect(%struct.TokenData* %token_array, i32* %index, i32 %len, i8 0, i8* @.str.182)
	...
	call void @expect(%struct.TokenData* %token_array, i32* %index, i32 %len, i8 1, i8* @.str.183)
	call void @expect(%struct.TokenData* %token_array, i32* %index, i32 %len, i8 6, i8* @.str.184)
...
then6:
	...
	call void @expect(%struct.TokenData* %token_array, i32* %index, i32 %len, i8 8, i8* @.str.185)
	...
	call void @expect(%struct.TokenData* %token_array, i32* %index, i32 %len, i8 5, i8* @.str.186)
...
then8:
	...
	call void @expect(%struct.TokenData* %tokens, i32* %index, i32 %len, i8 1, i8* @.str.191)
	br label %endif8
else8:
...
then14:
	call void @process.throw(i8* @.str.192)
	br label %endif14
endif14:
	br label %endif13
endif13:
	br label %loop_start10
loop_body10_exit:
	call void @expect(%struct.TokenData* %tokens, i32* %index, i32 %len, i8 5, i8* @.str.193)
	store i32 14, i32* %v0
...
endif39:
	br label %loop_start36
loop_body36_exit:
	call void @expect(%struct.TokenData* %tokens, i32* %index, i32 %len, i8 1, i8* @.str.11)
	store i32 12, i32* %v0
...
then41:
	...
	call void @expect(%struct.TokenData* %tokens, i32* %index, i32 %len, i8 5, i8* @.str.196)
	store i32 13, i32* %v0
...
endif47:
	br label %loop_start44
loop_body44_exit:
	call void @expect(%struct.TokenData* %tokens, i32* %index, i32 %len, i8 26, i8* @.str.198)
	store i32 11, i32* %v0
...
endif52:
	...
	call void @expect(%struct.TokenData* %tokens, i32* %index, i32 %len, i8 65, i8* @.str.199)
	call void @expect(%struct.TokenData* %tokens, i32* %index, i32 %len, i8 6, i8* @.str.118)
...
loop_body50_exit:
; Variable fe is out.
	call void @expect(%struct.TokenData* %tokens, i32* %index, i32 %len, i8 3, i8* @.str.201)
	store i32 15, i32* %v0
...
then18:
	br label %func_exit
endif18:
	call void @process.throw(i8* @.str.209)
	br label %func_exit
func_exit:
