...
define void @process.throw(i8* %exception){
    ...
    call void @console.writeln(i8* @.str.0, i32 11)
...
define void @console.println_u64(i64 %n){
    ...
    br i1 %tmp1, label %then0, label %endif0
then0:
    call void @console.write(i8* @.str.5, i32 2)
    ret void
    br label %endif0
endif0:
    store i64 %n, i64* %v1
...
define %struct.string.String @string.clone(%struct.string.String* %src){
    ...
    store i8* %tmp9, i8** %tmp3
    %tmp10 = getelementptr inbounds %struct.string.String, %struct.string.String* %src, i32 0, i32 0
    %tmp11 = load i8*, i8** %tmp10
    %tmp12 = getelementptr inbounds %struct.string.String, %struct.string.String* %v0, i32 0, i32 0
    ...
    call void @mem.copy(i8* %tmp11, i8* %tmp13, i64 %tmp16)
    %tmp17 = getelementptr inbounds %struct.string.String, %struct.string.String* %v0, i32 0, i32 0
...
define %struct.string.String @fs.read_full_file_as_string(i8* %path){
    ...
    br i1 %tmp2, label %then0, label %endif0
then0:
    %tmp3 = call i8* @string_utils.insert(i8* @.str.6, i8* %path, i32 16)
...
define void @tests.run(){
    ...
    call void @console.write(i8* @.str.8, i32 19)
...
define void @tests.mem_test(){
    %v0 = alloca i64; var: i
    %v1 = alloca i64; var: i
    call void @console.write(i8* @.str.9, i32 10)
...
define void @tests.string_utils_test(){
    %v0 = alloca i32; var: i
    call void @console.write(i8* @.str.16, i32 19)
    %tmp0 = call i32 @string_utils.c_str_len(i8* @.str.17)
...
then0:
    ...
    br label %endif0
endif0:
    %tmp2 = call i32 @string_utils.c_str_len(i8* @.str.19)
...
then4:
    ...
    br label %endif4
endif4:
    %tmp16 = call i8* @string_utils.insert(i8* @.str.24, i8* @.str.25, i32 1)
    store i32 0, i32* %v0
    br label %loop_body5
loop_body5:
    ...
    %tmp22 = getelementptr inbounds i8, i8* @.str.26, i32 %tmp21
...
endif6:
    ...
    %tmp30 = getelementptr inbounds i8, i8* @.str.26, i32 %tmp29
...
define void @tests.string_test(){
    ...
    call void @console.write(i8* @.str.28, i32 13)
    %tmp0 = call %struct.string.String @string.from_c_string(i8* @.str.29)
    store %struct.string.String %tmp0, %struct.string.String* %v0
    %tmp1 = call %struct.string.String @string.from_c_string(i8* @.str.29)
    store %struct.string.String %tmp1, %struct.string.String* %v1
    %tmp2 = call %struct.string.String @string.from_c_string(i8* @.str.30)
...
then2:
    ...
    br label %endif2
endif2:
    %tmp9 = call %struct.string.String @string.concat_with_c_string(%struct.string.String* %v0, i8* @.str.34)
    store %struct.string.String %tmp9, %struct.string.String* %v3
    %tmp10 = call %struct.string.String @string.from_c_string(i8* @.str.35)
...
define void @tests.vector_test(){
    ...
    call void @console.write(i8* @.str.38, i32 13)
...
then4:
    ...
    br label %endif4
endif4:
    call void @"vector.push_bulk<i8>"(%"struct.vector.Vec<i8>"* %v0, i8* @.str.44, i32 2)
...
define void @tests.list_test(){
    ...
    call void @console.write(i8* @.str.48, i32 11)
...
define void @tests.process_test(){
    ...
    call void @console.write(i8* @.str.57, i32 14)
    %tmp0 = call %struct.string.String @process.get_executable_path()
    store %struct.string.String %tmp0, %struct.string.String* %v0
...
then3:
    ...
    br label %endif3
endif3:
    call void @console.write(i8* @.str.62, i32 17)
    ...
    call void @console.write(i8* @.str.63, i32 18)
...
define void @tests.console_test(){
    call void @console.writeln(i8* @.str.64, i32 14)
    call void @console.writeln(i8* @.str.65, i32 25)
    call void @console.write(i8* @.str.66, i32 21)
    call void @console.println_i64(i64 12345)
    call void @console.write(i8* @.str.67, i32 22)
    call void @console.println_i64(i64 -67890)
    call void @console.write(i8* @.str.68, i32 17)
    call void @console.println_i64(i64 0)
    call void @console.write(i8* @.str.69, i32 26)
    call void @console.println_u64(i64 9876543210)
    call void @console.writeln(i8* @.str.70, i32 23)
    call void @console.writeln(i8* @.str.15, i32 2)
    ret void
}
define void @tests.fs_test(){
    ...
    call void @console.write(i8* @.str.71, i32 9)
    %tmp0 = call %struct.string.String @string.from_c_string(i8* @.str.72)
    store %struct.string.String %tmp0, %struct.string.String* %v0
    %tmp1 = call %struct.string.String @process.get_executable_env_path()
    store %struct.string.String %tmp1, %struct.string.String* %v1
    %tmp2 = call %struct.string.String @string.concat_with_c_string(%struct.string.String* %v1, i8* @.str.73)
    store %struct.string.String %tmp2, %struct.string.String* %v2
...
define void @tests.funny(){
    ...
    %tmp0 = call i32 @fs.create_file(i8* @.str.75)
    %tmp1 = icmp eq i32 %tmp0, 1
    br i1 %tmp1, label %then0, label %endif0
then0:
    call i32 @fs.delete_file(i8* @.str.75)
    ret void
    br label %endif0
endif0:
    %tmp2 = call %struct.string.String @fs.read_full_file_as_string(i8* @.str.75)
...
endif2:
    ...
    %tmp29 = call i8* @CreateWindowExA(i32 0, i8* @.str.78, i8* @.str.80, i32 13565952, i32 2147483648, i32 2147483648, i32 800, i32 600, i8* %tmp26, i8* %tmp27, i8* %tmp1, i8* %tmp28)
    %iv30 = alloca i1
...
then1:
    ...
    br label %endif1
endif1:
    %tmp5 = call i8* @window.load_bitmap_from_file(i8* %imagePath)
    %tmp6 = inttoptr i64 0 to i8*
...
endif2:
    store i32 0, i32* %v0
    store i32 0, i32* %v1
    call void @window.get_bitmap_dimensions(i8* %tmp5, i32* %v0, i32* %v1)
    %tmp8 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v2, i32 0, i32 0
    store i32 80, i32* %tmp8
    %tmp9 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v2, i32 0, i32 1
    %tmp10 = or i32 2, 1
    store i32 %tmp10, i32* %tmp9
    %tmp11 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v2, i32 0, i32 2
    store i64 (i8*, i32, i64, i64)** @window.WindowProc, i64 (i8*, i32, i64, i64)*** %tmp11
    %tmp12 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v2, i32 0, i32 3
    store i32 0, i32* %tmp12
    %tmp13 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v2, i32 0, i32 4
    store i32 0, i32* %tmp13
    %tmp14 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v2, i32 0, i32 5
    store i8* %tmp1, i8** %tmp14
    %tmp15 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v2, i32 0, i32 6
    %tmp16 = inttoptr i64 0 to i8*
    store i8* %tmp16, i8** %tmp15
    %tmp17 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v2, i32 0, i32 7
    %tmp18 = inttoptr i64 0 to i8*
    store i8* %tmp18, i8** %tmp17
    %tmp19 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v2, i32 0, i32 8
    %tmp20 = add i32 5, 1
    %tmp21 = inttoptr i32 %tmp20 to i8*
    store i8* %tmp21, i8** %tmp19
    %tmp22 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v2, i32 0, i32 9
    %tmp23 = inttoptr i64 0 to i8*
    store i8* %tmp23, i8** %tmp22
    %tmp24 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v2, i32 0, i32 10
    store i8* @.str.83, i8** %tmp24
    %tmp25 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v2, i32 0, i32 11
    %tmp26 = inttoptr i64 0 to i8*
    store i8* %tmp26, i8** %tmp25
    %tmp27 = call i16 @RegisterClassExA(%struct.window.WNDCLASSEXA* %v2)
    %tmp28 = icmp eq i16 %tmp27, 0
    br i1 %tmp28, label %then3, label %endif3
then3:
    call void @process.throw(i8* @.str.79)
    br label %endif3
endif3:
    %tmp29 = or i32 2147483648, 268435456
    %tmp30 = load i32, i32* %v0
    %tmp31 = load i32, i32* %v1
    %tmp32 = inttoptr i64 0 to i8*
    %tmp33 = inttoptr i64 0 to i8*
    %tmp34 = inttoptr i64 0 to i8*
    %tmp35 = call i8* @CreateWindowExA(i32 8, i8* @.str.83, i8* @.str.84, i32 %tmp29, i32 100, i32 100, i32 %tmp30, i32 %tmp31, i8* %tmp32, i8* %tmp33, i8* %tmp1, i8* %tmp34)
    %iv36 = alloca i1
    %tmp37 = icmp eq ptr %tmp35, null
    store i1 %tmp37, i1* %iv36
    br label %inline_exit4
inline_exit4:
    %tmp38 = load i1, i1* %iv36
    br i1 %tmp38, label %then5, label %endif5
then5:
    call void @process.throw(i8* @.str.81)
    br label %endif5
endif5:
    call i64 @SetWindowLongPtrA(i8* %tmp35, i32 -21, i8* %tmp5)
    call i32 @ShowWindow(i8* %tmp35, i32 5)
    call i32 @GetClientRect(i8* %tmp35, %struct.window.RECT* %v3)
    call i32 @InvalidateRect(i8* %tmp35, %struct.window.RECT* %v3, i32 1)
    br label %loop_body6
loop_body6:
    %tmp39 = inttoptr i64 0 to i8*
    %tmp40 = call i32 @GetMessageA(%struct.window.MSG* %v4, i8* %tmp39, i32 0, i32 0)
    %tmp41 = icmp sle i32 %tmp40, 0
