...
@.str.9 = private unnamed_addr constant [17 x i8] c"File not found: \00"
@.str.10 = private unnamed_addr constant [17 x i8] c"File read failed\00"
@.str.11 = private unnamed_addr constant [14 x i8] c"Out of memory\00"
@.str.12 = private unnamed_addr constant [10 x i8] c"fs_test: \00"
@.str.13 = private unnamed_addr constant [47 x i8] c"The quick brown fox jumps over crazy lost dog.\00"
@.str.14 = private unnamed_addr constant [9 x i8] c"test.txt\00"
@.str.15 = private unnamed_addr constant [38 x i8] c"Filesystem test failed, data mismatch\00"
@.str.16 = private unnamed_addr constant [3 x i8] c"OK\00"
@.str.17 = private unnamed_addr constant [15 x i8] c"\0Aconsole_test:\00"
@.str.18 = private unnamed_addr constant [26 x i8] c"--- VISUAL TEST START ---\00"
@.str.19 = private unnamed_addr constant [22 x i8] c"Printing i64(12345): \00"
@.str.20 = private unnamed_addr constant [23 x i8] c"Printing i64(-67890): \00"
@.str.21 = private unnamed_addr constant [18 x i8] c"Printing i64(0): \00"
@.str.22 = private unnamed_addr constant [27 x i8] c"Printing u64(9876543210): \00"
@.str.23 = private unnamed_addr constant [24 x i8] c"--- VISUAL TEST END ---\00"
@.str.24 = private unnamed_addr constant [3 x i8] c"0\0A\00"
@.str.25 = private unnamed_addr constant [15 x i8] c"process_test: \00"
@.str.26 = private unnamed_addr constant [49 x i8] c"process_test: get_executable_path returned empty\00"
@.str.27 = private unnamed_addr constant [53 x i8] c"process_test: get_executable_env_path returned empty\00"
@.str.28 = private unnamed_addr constant [53 x i8] c"process_test: env path is not shorter than full path\00"
@.str.29 = private unnamed_addr constant [53 x i8] c"process_test: env path does not end with a backslash\00"
@.str.30 = private unnamed_addr constant [18 x i8] c"Executable Path: \00"
@.str.31 = private unnamed_addr constant [19 x i8] c"Environment Path: \00"
@.str.32 = private unnamed_addr constant [12 x i8] c"list_test: \00"
@.str.33 = private unnamed_addr constant [22 x i8] c"list_test: new failed\00"
@.str.34 = private unnamed_addr constant [41 x i8] c"list_test: length incorrect after extend\00"
@.str.35 = private unnamed_addr constant [33 x i8] c"list_test: walk length incorrect\00"
@.str.36 = private unnamed_addr constant [36 x i8] c"list_test: data mismatch for node 1\00"
@.str.37 = private unnamed_addr constant [36 x i8] c"list_test: data mismatch for node 2\00"
@.str.38 = private unnamed_addr constant [36 x i8] c"list_test: data mismatch for node 3\00"
@.str.39 = private unnamed_addr constant [33 x i8] c"list_test: foot pointer mismatch\00"
@.str.40 = private unnamed_addr constant [23 x i8] c"list_test: free failed\00"
@.str.41 = private unnamed_addr constant [14 x i8] c"vector_test: \00"
@.str.42 = private unnamed_addr constant [24 x i8] c"vector_test: new failed\00"
@.str.43 = private unnamed_addr constant [33 x i8] c"vector_test: initial push failed\00"
@.str.44 = private unnamed_addr constant [36 x i8] c"vector_test: initial content failed\00"
@.str.45 = private unnamed_addr constant [28 x i8] c"vector_test: realloc failed\00"
@.str.46 = private unnamed_addr constant [36 x i8] c"vector_test: realloc content failed\00"
@.str.47 = private unnamed_addr constant [3 x i8] c"AB\00"
@.str.48 = private unnamed_addr constant [37 x i8] c"vector_test: push_bulk length failed\00"
@.str.49 = private unnamed_addr constant [38 x i8] c"vector_test: push_bulk content failed\00"
@.str.50 = private unnamed_addr constant [25 x i8] c"vector_test: free failed\00"
@.str.51 = private unnamed_addr constant [14 x i8] c"string_test: \00"
@.str.52 = private unnamed_addr constant [6 x i8] c"hello\00"
@.str.53 = private unnamed_addr alias [6 x i8], [6 x i8]* bitcast (i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.58, i64 0, i64 6) to [6 x i8]*)
@.str.54 = private unnamed_addr constant [41 x i8] c"string_test: from_c_string length failed\00"
@.str.55 = private unnamed_addr constant [40 x i8] c"string_test: equal positive case failed\00"
@.str.56 = private unnamed_addr constant [40 x i8] c"string_test: equal negative case failed\00"
@.str.57 = private unnamed_addr alias [7 x i8], [7 x i8]* bitcast (i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.58, i64 0, i64 5) to [7 x i8]*)
@.str.58 = private unnamed_addr constant [12 x i8] c"hello world\00"
@.str.59 = private unnamed_addr constant [34 x i8] c"string_test: concat length failed\00"
@.str.60 = private unnamed_addr constant [35 x i8] c"string_test: concat content failed\00"
@.str.61 = private unnamed_addr constant [20 x i8] c"string_utils_test: \00"
@.str.62 = private unnamed_addr constant [5 x i8] c"test\00"
@.str.63 = private unnamed_addr constant [36 x i8] c"string_utils_test: c_str_len failed\00"
@.str.64 = private unnamed_addr alias [1 x i8], [1 x i8]* bitcast (i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.0, i64 0, i64 47) to [1 x i8]*)
@.str.65 = private unnamed_addr constant [42 x i8] c"string_utils_test: c_str_len empty failed\00"
@.str.66 = private unnamed_addr constant [39 x i8] c"string_utils_test: is_ascii_num failed\00"
@.str.67 = private unnamed_addr constant [40 x i8] c"string_utils_test: is_ascii_char failed\00"
@.str.68 = private unnamed_addr constant [39 x i8] c"string_utils_test: is_ascii_hex failed\00"
@.str.69 = private unnamed_addr constant [3 x i8] c"ac\00"
@.str.70 = private unnamed_addr constant [2 x i8] c"b\00"
@.str.71 = private unnamed_addr constant [4 x i8] c"abc\00"
@.str.72 = private unnamed_addr constant [33 x i8] c"string_utils_test: insert failed\00"
@.str.73 = private unnamed_addr constant [11 x i8] c"mem_test: \00"
@.str.74 = private unnamed_addr constant [24 x i8] c"mem_test: malloc failed\00"
@.str.75 = private unnamed_addr constant [35 x i8] c"mem_test: fill verification failed\00"
@.str.76 = private unnamed_addr constant [40 x i8] c"mem_test: zero_fill verification failed\00"
@.str.77 = private unnamed_addr constant [33 x i8] c"mem_test: malloc for copy failed\00"
@.str.78 = private unnamed_addr constant [35 x i8] c"mem_test: copy verification failed\00"
@.str.79 = private unnamed_addr constant [33 x i8] c"Failed to lock heap for walking.\00"
...
define i32 @main(){
    ...
    %tmp0 = call %"struct.Pair<i32, %struct.Pair<i8, %struct.string.String>>" @"ax<i32>"()
    store %"struct.Pair<i32, %struct.Pair<i8, %struct.string.String>>" %tmp0, %"struct.Pair<i32, %struct.Pair<i8, %struct.string.String>>"* %v0
...
then1:
    ...
    br label %endif1
endif1:
    %tmp5 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v0, i32 0, i32 0
    ...
    %tmp8 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v0, i32 0, i32 2
    store i64 (i8*, i32, i64, i64)** @window.WindowProc, i64 (i8*, i32, i64, i64)*** %tmp8
    %tmp9 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v0, i32 0, i32 3
    store i32 0, i32* %tmp9
    %tmp10 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v0, i32 0, i32 4
    store i32 0, i32* %tmp10
    %tmp11 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v0, i32 0, i32 5
    store i8* %tmp1, i8** %tmp11
    %tmp12 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v0, i32 0, i32 6
    %tmp13 = inttoptr i64 0 to i8*
    store i8* %tmp13, i8** %tmp12
    %tmp14 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v0, i32 0, i32 7
    %tmp15 = inttoptr i64 0 to i8*
    store i8* %tmp15, i8** %tmp14
    %tmp16 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v0, i32 0, i32 8
    %tmp17 = add i32 5, 1
    %tmp18 = inttoptr i32 %tmp17 to i8*
    store i8* %tmp18, i8** %tmp16
    %tmp19 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v0, i32 0, i32 9
    %tmp20 = inttoptr i64 0 to i8*
    store i8* %tmp20, i8** %tmp19
    %tmp21 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v0, i32 0, i32 10
    store i8* @.str.1, i8** %tmp21
    %tmp22 = getelementptr inbounds %struct.window.WNDCLASSEXA, %struct.window.WNDCLASSEXA* %v0, i32 0, i32 11
    %tmp23 = inttoptr i64 0 to i8*
    store i8* %tmp23, i8** %tmp22
    %tmp24 = call i16 @RegisterClassExA(%struct.window.WNDCLASSEXA* %v0)
    %tmp25 = icmp eq i16 %tmp24, 0
...
endif2:
    ...
    %tmp27 = inttoptr i64 0 to i8*
    %tmp28 = inttoptr i64 0 to i8*
    %tmp29 = call i8* @CreateWindowExA(i32 0, i8* @.str.1, i8* @.str.3, i32 13565952, i32 2147483648, i32 2147483648, i32 800, i32 600, i8* %tmp26, i8* %tmp27, i8* %tmp1, i8* %tmp28)
    %iv30 = alloca i1
    %tmp31 = icmp eq ptr %tmp29, null
    store i1 %tmp31, i1* %iv30
    br label %inline_exit3
inline_exit3:
    %tmp32 = load i1, i1* %iv30
    br i1 %tmp32, label %then4, label %endif4
then4:
    call void @process.throw(i8* @.str.4)
    br label %endif4
endif4:
    call i32 @ShowWindow(i8* %tmp29, i32 5)
    br label %loop_body5
loop_body5:
    %tmp33 = inttoptr i64 0 to i8*
    %tmp34 = call i32 @GetMessageA(%struct.window.MSG* %v1, i8* %tmp33, i32 0, i32 0)
    %tmp35 = icmp sle i32 %tmp34, 0
    br i1 %tmp35, label %then6, label %endif6
then6:
...
endif2:
    ...
    %tmp12 = getelementptr inbounds i8, i8* %tmp10, i32 %tmp11
    %tmp13 = load i8, i8* %tmp12
    store i8 %tmp13, i8* %v2
    %tmp14 = load i8, i8* %v2
    %tmp15 = icmp eq i8 %tmp14, 32
    %tmp16 = load i8, i8* %v2
    %tmp17 = icmp eq i8 %tmp16, 9
    %tmp18 = or i1 %tmp15, %tmp17
    %tmp19 = load i8, i8* %v2
    %tmp20 = icmp eq i8 %tmp19, 13
...
then4:
    %tmp32 = getelementptr inbounds %struct.string.String, %struct.string.String* %v0, i32 0, i32 0
    %tmp33 = load i8*, i8** %tmp32
    %tmp34 = load i32, i32* %v1
    %tmp35 = add i32 %tmp34, 1
    %tmp36 = getelementptr inbounds i8, i8* %tmp33, i32 %tmp35
    %tmp37 = load i8, i8* %tmp36
    store i8 %tmp37, i8* %v3
    br label %endif4
else4:
    store i8 0, i8* %v3
    br label %endif4
...
endif7:
    ...
    %tmp57 = getelementptr inbounds %struct.string.String, %struct.string.String* %v0, i32 0, i32 0
    %tmp58 = load i8*, i8** %tmp57
    %tmp59 = load i32, i32* %v4
    %tmp60 = getelementptr i8, i8* %tmp58, i32 %tmp59
    %tmp61 = getelementptr inbounds %struct.string.String, %struct.string.String* %v7, i32 0, i32 0
    ...
    call void @"vector.push<%struct.string.String>"(%"struct.vector.Vec<%struct.string.String>"* %v5, %struct.string.String %tmp66)
    br label %loop_body1
    br label %endif6
endif6:
    %tmp67 = load i8, i8* %v2
    %tmp68 = call i1 @string_utils.is_ascii_char(i8 %tmp67)
    %tmp69 = load i8, i8* %v2
    %tmp70 = icmp eq i8 %tmp69, 95
    %tmp71 = or i1 %tmp68, %tmp70
    br i1 %tmp71, label %then8, label %endif8
then8:
    %tmp72 = load i32, i32* %v1
    store i32 %tmp72, i32* %v4
    call void @tests.consume_while(%struct.string.String* %v0, i32* %v1, i1 (i8)** @tests.valid_name_token)
    %tmp73 = load i32, i32* %v1
    %tmp74 = load i32, i32* %v4
    %tmp75 = sub i32 %tmp73, %tmp74
    %tmp76 = call %struct.string.String @string.with_size(i32 %tmp75)
    store %struct.string.String %tmp76, %struct.string.String* %v8
    %tmp77 = getelementptr inbounds %struct.string.String, %struct.string.String* %v0, i32 0, i32 0
    %tmp78 = load i8*, i8** %tmp77
    %tmp79 = load i32, i32* %v4
    %tmp80 = getelementptr i8, i8* %tmp78, i32 %tmp79
    %tmp81 = getelementptr inbounds %struct.string.String, %struct.string.String* %v8, i32 0, i32 0
    %tmp82 = load i8*, i8** %tmp81
    %tmp83 = getelementptr inbounds %struct.string.String, %struct.string.String* %v8, i32 0, i32 1
    %tmp84 = load i32, i32* %tmp83
    %tmp85 = sext i32 %tmp84 to i64
    call void @mem.copy(i8* %tmp80, i8* %tmp82, i64 %tmp85)
    %tmp86 = load %struct.string.String, %struct.string.String* %v8
    call void @"vector.push<%struct.string.String>"(%"struct.vector.Vec<%struct.string.String>"* %v5, %struct.string.String %tmp86)
    br label %loop_body1
    br label %endif8
endif8:
    %tmp87 = load i8, i8* %v2
    %tmp88 = icmp eq i8 %tmp87, 34
    br i1 %tmp88, label %then9, label %endif9
then9:
    %tmp89 = load i32, i32* %v1
    store i32 %tmp89, i32* %v4
...
loop_body10:
    ...
    %tmp93 = getelementptr inbounds %struct.string.String, %struct.string.String* %v0, i32 0, i32 1
...
then11:
    ...
    br label %endif11
endif11:
    %tmp96 = getelementptr inbounds %struct.string.String, %struct.string.String* %v0, i32 0, i32 0
    %tmp97 = load i8*, i8** %tmp96
    %tmp98 = load i32, i32* %v1
    %tmp99 = getelementptr inbounds i8, i8* %tmp97, i32 %tmp98
    %tmp100 = load i8, i8* %tmp99
    %tmp101 = icmp eq i8 %tmp100, 34
    br i1 %tmp101, label %then12, label %endif12
then12:
    %tmp102 = load i32, i32* %v1
    %tmp103 = add i32 %tmp102, 1
    store i32 %tmp103, i32* %v1
    br label %loop_body10_exit
    br label %endif12
endif12:
    br label %loop_body10
loop_body10_exit:
    ...
    %tmp105 = load i32, i32* %v4
    %tmp106 = sub i32 %tmp104, %tmp105
    %tmp107 = call %struct.string.String @string.with_size(i32 %tmp106)
    store %struct.string.String %tmp107, %struct.string.String* %v9
    %tmp108 = getelementptr inbounds %struct.string.String, %struct.string.String* %v0, i32 0, i32 0
    %tmp109 = load i8*, i8** %tmp108
    %tmp110 = load i32, i32* %v4
    %tmp111 = getelementptr i8, i8* %tmp109, i32 %tmp110
    %tmp112 = getelementptr inbounds %struct.string.String, %struct.string.String* %v9, i32 0, i32 0
    %tmp113 = load i8*, i8** %tmp112
    %tmp114 = getelementptr inbounds %struct.string.String, %struct.string.String* %v9, i32 0, i32 1
    %tmp115 = load i32, i32* %tmp114
    %tmp116 = sext i32 %tmp115 to i64
    call void @mem.copy(i8* %tmp111, i8* %tmp113, i64 %tmp116)
    %tmp117 = load %struct.string.String, %struct.string.String* %v9
    call void @"vector.push<%struct.string.String>"(%"struct.vector.Vec<%struct.string.String>"* %v5, %struct.string.String %tmp117)
    br label %loop_body1
    br label %endif9
endif9:
    %tmp118 = load i8, i8* %v2
    %tmp119 = icmp eq i8 %tmp118, 39
    br i1 %tmp119, label %then13, label %endif13
then13:
    %tmp120 = load i32, i32* %v1
    %tmp121 = add i32 %tmp120, 1
    store i32 %tmp121, i32* %v1
    br label %loop_body1
    br label %endif13
endif13:
    %tmp122 = load i8, i8* %v2
    %tmp123 = icmp eq i8 %tmp122, 40
    br i1 %tmp123, label %then14, label %endif14
then14:
    %tmp124 = load i32, i32* %v1
    %tmp125 = add i32 %tmp124, 1
    store i32 %tmp125, i32* %v1
    br label %loop_body1
    br label %endif14
endif14:
    %tmp126 = load i8, i8* %v2
    %tmp127 = icmp eq i8 %tmp126, 41
    br i1 %tmp127, label %then15, label %endif15
then15:
    %tmp128 = load i32, i32* %v1
    %tmp129 = add i32 %tmp128, 1
    store i32 %tmp129, i32* %v1
    br label %loop_body1
    br label %endif15
endif15:
    %tmp130 = load i8, i8* %v2
    %tmp131 = icmp eq i8 %tmp130, 123
    br i1 %tmp131, label %then16, label %endif16
then16:
    %tmp132 = load i32, i32* %v1
    %tmp133 = add i32 %tmp132, 1
    store i32 %tmp133, i32* %v1
    br label %loop_body1
    br label %endif16
endif16:
    %tmp134 = load i8, i8* %v2
    %tmp135 = icmp eq i8 %tmp134, 125
    br i1 %tmp135, label %then17, label %endif17
then17:
    %tmp136 = load i32, i32* %v1
    %tmp137 = add i32 %tmp136, 1
    store i32 %tmp137, i32* %v1
    br label %loop_body1
    br label %endif17
endif17:
    %tmp138 = load i8, i8* %v2
    %tmp139 = icmp eq i8 %tmp138, 91
    br i1 %tmp139, label %then18, label %endif18
then18:
    %tmp140 = load i32, i32* %v1
    %tmp141 = add i32 %tmp140, 1
    store i32 %tmp141, i32* %v1
    br label %loop_body1
    br label %endif18
endif18:
    %tmp142 = load i8, i8* %v2
    %tmp143 = icmp eq i8 %tmp142, 93
    br i1 %tmp143, label %then19, label %endif19
then19:
    %tmp144 = load i32, i32* %v1
    %tmp145 = add i32 %tmp144, 1
    store i32 %tmp145, i32* %v1
    br label %loop_body1
    br label %endif19
endif19:
    %tmp146 = load i8, i8* %v2
    %tmp147 = icmp eq i8 %tmp146, 61
    br i1 %tmp147, label %then20, label %endif20
then20:
    %tmp148 = load i8, i8* %v3
    %tmp149 = icmp eq i8 %tmp148, 61
    br i1 %tmp149, label %then21, label %endif21
then21:
    %tmp150 = load i32, i32* %v1
    %tmp151 = add i32 %tmp150, 2
    store i32 %tmp151, i32* %v1
    br label %loop_body1
    br label %endif21
endif21:
    %tmp152 = load i32, i32* %v1
    %tmp153 = add i32 %tmp152, 1
    store i32 %tmp153, i32* %v1
    br label %loop_body1
    br label %endif20
endif20:
    %tmp154 = load i8, i8* %v2
    %tmp155 = icmp eq i8 %tmp154, 58
    br i1 %tmp155, label %then22, label %endif22
then22:
    %tmp156 = load i8, i8* %v3
    %tmp157 = icmp eq i8 %tmp156, 58
    br i1 %tmp157, label %then23, label %endif23
then23:
    %tmp158 = load i32, i32* %v1
    %tmp159 = add i32 %tmp158, 2
    store i32 %tmp159, i32* %v1
    br label %loop_body1
    br label %endif23
endif23:
    %tmp160 = load i32, i32* %v1
    %tmp161 = add i32 %tmp160, 1
    store i32 %tmp161, i32* %v1
    br label %loop_body1
    br label %endif22
endif22:
    %tmp162 = load i8, i8* %v2
    %tmp163 = icmp eq i8 %tmp162, 124
    br i1 %tmp163, label %then24, label %endif24
then24:
    %tmp164 = load i8, i8* %v3
    %tmp165 = icmp eq i8 %tmp164, 124
    br i1 %tmp165, label %then25, label %endif25
then25:
    %tmp166 = load i32, i32* %v1
    %tmp167 = add i32 %tmp166, 2
    store i32 %tmp167, i32* %v1
    br label %loop_body1
    br label %endif25
endif25:
    %tmp168 = load i32, i32* %v1
    %tmp169 = add i32 %tmp168, 1
    store i32 %tmp169, i32* %v1
    br label %loop_body1
    br label %endif24
endif24:
    %tmp170 = load i8, i8* %v2
    %tmp171 = icmp eq i8 %tmp170, 38
    br i1 %tmp171, label %then26, label %endif26
then26:
    %tmp172 = load i8, i8* %v3
    %tmp173 = icmp eq i8 %tmp172, 38
    br i1 %tmp173, label %then27, label %endif27
then27:
    %tmp174 = load i32, i32* %v1
    %tmp175 = add i32 %tmp174, 2
    store i32 %tmp175, i32* %v1
    br label %loop_body1
    br label %endif27
endif27:
    %tmp176 = load i32, i32* %v1
    %tmp177 = add i32 %tmp176, 1
    store i32 %tmp177, i32* %v1
    br label %loop_body1
    br label %endif26
endif26:
    %tmp178 = load i8, i8* %v2
    %tmp179 = icmp eq i8 %tmp178, 62
    br i1 %tmp179, label %then28, label %endif28
then28:
    %tmp180 = load i8, i8* %v3
    %tmp181 = icmp eq i8 %tmp180, 61
    br i1 %tmp181, label %then29, label %endif29
then29:
    %tmp182 = load i32, i32* %v1
    %tmp183 = add i32 %tmp182, 2
    store i32 %tmp183, i32* %v1
    br label %loop_body1
    br label %endif29
endif29:
    %tmp184 = load i32, i32* %v1
    %tmp185 = add i32 %tmp184, 1
    store i32 %tmp185, i32* %v1
    br label %loop_body1
    br label %endif28
endif28:
    %tmp186 = load i8, i8* %v2
    %tmp187 = icmp eq i8 %tmp186, 60
    br i1 %tmp187, label %then30, label %endif30
then30:
    %tmp188 = load i8, i8* %v3
    %tmp189 = icmp eq i8 %tmp188, 61
    br i1 %tmp189, label %then31, label %endif31
then31:
    %tmp190 = load i32, i32* %v1
    %tmp191 = add i32 %tmp190, 2
    store i32 %tmp191, i32* %v1
    br label %loop_body1
    br label %endif31
endif31:
    %tmp192 = load i32, i32* %v1
    %tmp193 = add i32 %tmp192, 1
    store i32 %tmp193, i32* %v1
    br label %loop_body1
    br label %endif30
endif30:
    %tmp194 = load i8, i8* %v2
    %tmp195 = icmp eq i8 %tmp194, 35
    br i1 %tmp195, label %then32, label %endif32
then32:
    %tmp196 = load i32, i32* %v1
    %tmp197 = add i32 %tmp196, 1
    store i32 %tmp197, i32* %v1
    br label %loop_body1
    br label %endif32
endif32:
    %tmp198 = load i8, i8* %v2
    %tmp199 = icmp eq i8 %tmp198, 59
    br i1 %tmp199, label %then33, label %endif33
then33:
    %tmp200 = load i32, i32* %v1
    %tmp201 = add i32 %tmp200, 1
    store i32 %tmp201, i32* %v1
    br label %loop_body1
    br label %endif33
endif33:
    %tmp202 = load i8, i8* %v2
    %tmp203 = icmp eq i8 %tmp202, 46
    br i1 %tmp203, label %then34, label %endif34
then34:
    %tmp204 = load i32, i32* %v1
    %tmp205 = add i32 %tmp204, 1
    store i32 %tmp205, i32* %v1
    br label %loop_body1
    br label %endif34
endif34:
    %tmp206 = load i8, i8* %v2
    %tmp207 = icmp eq i8 %tmp206, 44
    br i1 %tmp207, label %then35, label %endif35
then35:
    %tmp208 = load i32, i32* %v1
    %tmp209 = add i32 %tmp208, 1
    store i32 %tmp209, i32* %v1
    br label %loop_body1
    br label %endif35
endif35:
    %tmp210 = load i8, i8* %v2
    %tmp211 = icmp eq i8 %tmp210, 43
    br i1 %tmp211, label %then36, label %endif36
then36:
    %tmp212 = load i32, i32* %v1
    %tmp213 = add i32 %tmp212, 1
    store i32 %tmp213, i32* %v1
    br label %loop_body1
    br label %endif36
endif36:
    %tmp214 = load i8, i8* %v2
    %tmp215 = icmp eq i8 %tmp214, 45
    br i1 %tmp215, label %then37, label %endif37
then37:
    %tmp216 = load i32, i32* %v1
    %tmp217 = add i32 %tmp216, 1
    store i32 %tmp217, i32* %v1
    br label %loop_body1
    br label %endif37
endif37:
    %tmp218 = load i8, i8* %v2
    %tmp219 = icmp eq i8 %tmp218, 42
    br i1 %tmp219, label %then38, label %endif38
then38:
    %tmp220 = load i32, i32* %v1
    %tmp221 = add i32 %tmp220, 1
    store i32 %tmp221, i32* %v1
    br label %loop_body1
    br label %endif38
endif38:
    %tmp222 = load i8, i8* %v2
    %tmp223 = icmp eq i8 %tmp222, 47
    br i1 %tmp223, label %then39, label %endif39
then39:
    %tmp224 = load i32, i32* %v1
    %tmp225 = add i32 %tmp224, 1
    store i32 %tmp225, i32* %v1
    br label %loop_body1
    br label %endif39
endif39:
    %tmp226 = load i8, i8* %v2
    %tmp227 = icmp eq i8 %tmp226, 37
    br i1 %tmp227, label %then40, label %endif40
then40:
    %tmp228 = load i32, i32* %v1
    %tmp229 = add i32 %tmp228, 1
    store i32 %tmp229, i32* %v1
    br label %loop_body1
    br label %endif40
endif40:
    %tmp230 = load i8, i8* %v2
    %tmp231 = icmp eq i8 %tmp230, 33
    br i1 %tmp231, label %then41, label %endif41
then41:
    %tmp232 = load i32, i32* %v1
    %tmp233 = add i32 %tmp232, 1
    store i32 %tmp233, i32* %v1
    br label %loop_body1
    br label %endif41
endif41:
    %tmp234 = load i8, i8* %v2
    %tmp235 = icmp eq i8 %tmp234, 126
    br i1 %tmp235, label %then42, label %endif42
then42:
    %tmp236 = load i32, i32* %v1
    %tmp237 = add i32 %tmp236, 1
    store i32 %tmp237, i32* %v1
    br label %loop_body1
    br label %endif42
endif42:
    %tmp238 = load i8, i8* %v2
    %tmp239 = icmp eq i8 %tmp238, 92
    br i1 %tmp239, label %then43, label %endif43
then43:
    %tmp240 = load i32, i32* %v1
    %tmp241 = add i32 %tmp240, 1
    store i32 %tmp241, i32* %v1
    br label %loop_body1
    br label %endif43
endif43:
    %tmp242 = load i8, i8* %v2
    call void @console.print_char(i8 %tmp242)
...
loop_body44:
    %tmp245 = load i32, i32* %v10
    %tmp246 = getelementptr inbounds %"struct.vector.Vec<%struct.string.String>", %"struct.vector.Vec<%struct.string.String>"* %v5, i32 0, i32 1
    %tmp247 = load i32, i32* %tmp246
    %tmp248 = icmp uge i32 %tmp245, %tmp247
    br i1 %tmp248, label %then45, label %endif45
then45:
    br label %loop_body44_exit
    br label %endif45
endif45:
    %tmp249 = getelementptr inbounds %"struct.vector.Vec<%struct.string.String>", %"struct.vector.Vec<%struct.string.String>"* %v5, i32 0, i32 0
    %tmp250 = load %struct.string.String*, %struct.string.String** %tmp249
    %tmp251 = load i32, i32* %v10
    %tmp252 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp250, i32 %tmp251
    call void @string.free(%struct.string.String* %tmp252)
    %tmp253 = load i32, i32* %v10
    %tmp254 = add i32 %tmp253, 1
    store i32 %tmp254, i32* %v10
    br label %loop_body44
loop_body44_exit:
...
define %struct.string.String @fs.read_full_file_as_string(i8* %path){
    ...
    br i1 %tmp2, label %then0, label %endif0
then0:
    %tmp3 = call i8* @string_utils.insert(i8* @.str.9, i8* %path, i32 16)
...
endif2:
    ...
    %tmp21 = getelementptr inbounds %struct.string.String, %struct.string.String* %v1, i32 0, i32 1
    %tmp22 = load i32, i32* %tmp21
    %tmp23 = getelementptr inbounds i8, i8* %tmp20, i32 %tmp22
    store i8 0, i8* %tmp23
    %tmp24 = load %struct.string.String, %struct.string.String* %v1
...
define void @tests.fs_test(){
    ...
    call void @console.write(i8* @.str.12, i32 9)
    %tmp0 = call %struct.string.String @string.from_c_string(i8* @.str.13)
    ...
    %tmp2 = call %struct.string.String @string.concat_with_c_string(%struct.string.String* %v1, i8* @.str.14)
...
endif1:
    ...
    call void @string.free(%struct.string.String* %v1)
    call void @string.free(%struct.string.String* %v0)
    call void @console.writeln(i8* @.str.16, i32 2)
    ret void
}
...
define %struct.string.String @string.concat_with_c_string(%struct.string.String* %src_string, i8* %c_string){
    ...
    %tmp16 = getelementptr i8, i8* %tmp7, i64 %tmp15
...
define void @tests.console_test(){
    call void @console.writeln(i8* @.str.17, i32 14)
    call void @console.writeln(i8* @.str.18, i32 25)
    call void @console.write(i8* @.str.19, i32 21)
    call void @console.println_i64(i64 12345)
    call void @console.write(i8* @.str.20, i32 22)
    call void @console.println_i64(i64 -67890)
    call void @console.write(i8* @.str.21, i32 17)
    call void @console.println_i64(i64 0)
    call void @console.write(i8* @.str.22, i32 26)
    call void @console.println_u64(i64 9876543210)
    call void @console.writeln(i8* @.str.23, i32 23)
    call void @console.writeln(i8* @.str.16, i32 2)
    ret void
}
define void @console.println_u64(i64 %n){
    ...
    br i1 %tmp1, label %then0, label %endif0
then0:
    call void @console.write(i8* @.str.24, i32 2)
    ret void
    br label %endif0
endif0:
    store i64 %n, i64* %v1
...
define void @tests.process_test(){
    ...
    %v1 = alloca %struct.string.String; var: env_path
    call void @console.write(i8* @.str.25, i32 14)
    %tmp0 = call %struct.string.String @process.get_executable_path()
    store %struct.string.String %tmp0, %struct.string.String* %v0
    %tmp1 = call %struct.string.String @process.get_executable_env_path()
    store %struct.string.String %tmp1, %struct.string.String* %v1
...
endif2:
    ...
    %tmp18 = getelementptr inbounds i8, i8* %tmp14, i32 %tmp17
    %tmp19 = load i8, i8* %tmp18
    %tmp20 = icmp ne i8 %tmp19, 92
    br i1 %tmp20, label %then3, label %endif3
then3:
    call void @process.throw(i8* @.str.29)
    br label %endif3
endif3:
    call void @console.write(i8* @.str.30, i32 17)
    ...
    call void @console.writeln(i8* %tmp22, i32 %tmp24)
    call void @console.write(i8* @.str.31, i32 18)
    %tmp25 = getelementptr inbounds %struct.string.String, %struct.string.String* %v1, i32 0, i32 0
    %tmp26 = load i8*, i8** %tmp25
    %tmp27 = getelementptr inbounds %struct.string.String, %struct.string.String* %v1, i32 0, i32 1
    %tmp28 = load i32, i32* %tmp27
    call void @console.writeln(i8* %tmp26, i32 %tmp28)
    call void @string.free(%struct.string.String* %v0)
    call void @string.free(%struct.string.String* %v1)
    call void @console.writeln(i8* @.str.16, i32 2)
    ret void
...
define void @tests.list_test(){
    ...
    call void @console.write(i8* @.str.32, i32 11)
...
define void @tests.vector_test(){
    ...
    call void @console.write(i8* @.str.41, i32 13)
...
endif1:
    ...
    %tmp19 = icmp ne i8 %tmp18, 10
    %tmp20 = getelementptr inbounds %"struct.vector.Vec<i8>", %"struct.vector.Vec<i8>"* %v0, i32 0, i32 0
    %tmp21 = load i8*, i8** %tmp20
    %tmp22 = getelementptr inbounds i8, i8* %tmp21, i64 3
    %tmp23 = load i8, i8* %tmp22
    %tmp24 = icmp ne i8 %tmp23, 40
    %tmp25 = or i1 %tmp19, %tmp24
    br i1 %tmp25, label %then2, label %endif2
then2:
...
endif2:
    ...
    %tmp26 = getelementptr inbounds %"struct.vector.Vec<i8>", %"struct.vector.Vec<i8>"* %v0, i32 0, i32 1
    %tmp27 = load i32, i32* %tmp26
    %tmp28 = icmp ne i32 %tmp27, 5
    %tmp29 = getelementptr inbounds %"struct.vector.Vec<i8>", %"struct.vector.Vec<i8>"* %v0, i32 0, i32 2
    %tmp30 = load i32, i32* %tmp29
    %tmp31 = icmp ne i32 %tmp30, 8
    %tmp32 = or i1 %tmp28, %tmp31
    br i1 %tmp32, label %then3, label %endif3
then3:
    call void @process.throw(i8* @.str.45)
    br label %endif3
endif3:
    %tmp33 = getelementptr inbounds %"struct.vector.Vec<i8>", %"struct.vector.Vec<i8>"* %v0, i32 0, i32 0
    %tmp34 = load i8*, i8** %tmp33
    %tmp35 = getelementptr inbounds i8, i8* %tmp34, i64 4
    %tmp36 = load i8, i8* %tmp35
    %tmp37 = icmp ne i8 %tmp36, 50
    %tmp38 = getelementptr inbounds %"struct.vector.Vec<i8>", %"struct.vector.Vec<i8>"* %v0, i32 0, i32 0
    %tmp39 = load i8*, i8** %tmp38
    %tmp40 = getelementptr inbounds i8, i8* %tmp39, i64 0
    %tmp41 = load i8, i8* %tmp40
    %tmp42 = icmp ne i8 %tmp41, 10
    %tmp43 = or i1 %tmp37, %tmp42
    br i1 %tmp43, label %then4, label %endif4
then4:
    call void @process.throw(i8* @.str.46)
    br label %endif4
endif4:
    call void @"vector.push_bulk<i8>"(%"struct.vector.Vec<i8>"* %v0, i8* @.str.47, i32 2)
    %tmp44 = getelementptr inbounds %"struct.vector.Vec<i8>", %"struct.vector.Vec<i8>"* %v0, i32 0, i32 1
    %tmp45 = load i32, i32* %tmp44
    %tmp46 = icmp ne i32 %tmp45, 7
...
endif5:
    ...
    %tmp49 = getelementptr inbounds i8, i8* %tmp48, i64 5
    %tmp50 = load i8, i8* %tmp49
    %tmp51 = icmp ne i8 %tmp50, 65
    %tmp52 = getelementptr inbounds %"struct.vector.Vec<i8>", %"struct.vector.Vec<i8>"* %v0, i32 0, i32 0
    %tmp53 = load i8*, i8** %tmp52
    %tmp54 = getelementptr inbounds i8, i8* %tmp53, i64 6
    %tmp55 = load i8, i8* %tmp54
    %tmp56 = icmp ne i8 %tmp55, 66
    %tmp57 = or i1 %tmp51, %tmp56
...
endif6:
    ...
    %tmp58 = getelementptr inbounds %"struct.vector.Vec<i8>", %"struct.vector.Vec<i8>"* %v0, i32 0, i32 1
    %tmp59 = load i32, i32* %tmp58
    %tmp60 = icmp ne i32 %tmp59, 0
    %tmp61 = getelementptr inbounds %"struct.vector.Vec<i8>", %"struct.vector.Vec<i8>"* %v0, i32 0, i32 2
    %tmp62 = load i32, i32* %tmp61
    %tmp63 = icmp ne i32 %tmp62, 0
    %tmp64 = or i1 %tmp60, %tmp63
    %tmp65 = getelementptr inbounds %"struct.vector.Vec<i8>", %"struct.vector.Vec<i8>"* %v0, i32 0, i32 0
    %tmp66 = load i8*, i8** %tmp65
    %tmp67 = icmp ne ptr %tmp66, null
    %tmp68 = or i1 %tmp64, %tmp67
    br i1 %tmp68, label %then7, label %endif7
then7:
...
define void @tests.string_test(){
    ...
    call void @console.write(i8* @.str.51, i32 13)
    %tmp0 = call %struct.string.String @string.from_c_string(i8* @.str.52)
    store %struct.string.String %tmp0, %struct.string.String* %v0
    %tmp1 = call %struct.string.String @string.from_c_string(i8* @.str.52)
    store %struct.string.String %tmp1, %struct.string.String* %v1
    %tmp2 = call %struct.string.String @string.from_c_string(i8* @.str.53)
    store %struct.string.String %tmp2, %struct.string.String* %v2
    %tmp3 = getelementptr inbounds %struct.string.String, %struct.string.String* %v0, i32 0, i32 1
    %tmp4 = load i32, i32* %tmp3
...
then2:
    ...
    br label %endif2
endif2:
    %tmp9 = call %struct.string.String @string.concat_with_c_string(%struct.string.String* %v0, i8* @.str.57)
    store %struct.string.String %tmp9, %struct.string.String* %v3
    %tmp10 = call %struct.string.String @string.from_c_string(i8* @.str.58)
...
define void @tests.string_utils_test(){
    %v0 = alloca i32; var: i
    call void @console.write(i8* @.str.61, i32 19)
    %tmp0 = call i32 @string_utils.c_str_len(i8* @.str.62)
...
then0:
    ...
    br label %endif0
endif0:
    %tmp2 = call i32 @string_utils.c_str_len(i8* @.str.64)
    %tmp3 = icmp ne i32 %tmp2, 0
    br i1 %tmp3, label %then1, label %endif1
then1:
...
then4:
    ...
    br label %endif4
endif4:
    %tmp16 = call i8* @string_utils.insert(i8* @.str.69, i8* @.str.70, i32 1)
    store i32 0, i32* %v0
    br label %loop_body5
loop_body5:
    ...
    %tmp22 = getelementptr inbounds i8, i8* @.str.71, i32 %tmp21
    %tmp23 = load i8, i8* %tmp22
...
endif6:
    ...
    %tmp30 = getelementptr inbounds i8, i8* @.str.71, i32 %tmp29
...
define void @tests.mem_test(){
    %v0 = alloca i64; var: i
    %v1 = alloca i64; var: i
    call void @console.write(i8* @.str.73, i32 10)
...
endif0:
    ...
    %tmp21 = load %struct.string.String*, %struct.string.String** %tmp20
    ...
    %tmp24 = getelementptr inbounds %struct.string.String, %struct.string.String* %tmp21, i32 %tmp23
    store %struct.string.String %data, %struct.string.String* %tmp24
