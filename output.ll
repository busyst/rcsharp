...
@.str.6 = private unnamed_addr constant [3 x i8] c"0\0A\00"
@.str.7 = private unnamed_addr constant [14 x i8] c"vector_test: \00"
@.str.8 = private unnamed_addr constant [24 x i8] c"vector_test: new failed\00"
@.str.9 = private unnamed_addr constant [33 x i8] c"vector_test: initial push failed\00"
@.str.10 = private unnamed_addr constant [36 x i8] c"vector_test: initial content failed\00"
@.str.11 = private unnamed_addr constant [28 x i8] c"vector_test: realloc failed\00"
@.str.12 = private unnamed_addr constant [36 x i8] c"vector_test: realloc content failed\00"
@.str.13 = private unnamed_addr constant [3 x i8] c"AB\00"
@.str.14 = private unnamed_addr constant [37 x i8] c"vector_test: push_bulk length failed\00"
@.str.15 = private unnamed_addr constant [38 x i8] c"vector_test: push_bulk content failed\00"
@.str.16 = private unnamed_addr constant [25 x i8] c"vector_test: free failed\00"
@.str.17 = private unnamed_addr constant [3 x i8] c"OK\00"
@.str.18 = private unnamed_addr constant [20 x i8] c"string_utils_test: \00"
@.str.19 = private unnamed_addr constant [5 x i8] c"test\00"
@.str.20 = private unnamed_addr constant [36 x i8] c"string_utils_test: c_str_len failed\00"
@.str.21 = private unnamed_addr alias [1 x i8], [1 x i8]* bitcast (i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.0, i64 0, i64 47) to [1 x i8]*)
@.str.22 = private unnamed_addr constant [42 x i8] c"string_utils_test: c_str_len empty failed\00"
@.str.23 = private unnamed_addr constant [32 x i8] c"char_utils: charis_digit failed\00"
@.str.24 = private unnamed_addr constant [28 x i8] c"char_utils: is_alpha failed\00"
@.str.25 = private unnamed_addr constant [29 x i8] c"char_utils: is_xdigit failed\00"
@.str.26 = private unnamed_addr constant [3 x i8] c"ac\00"
@.str.27 = private unnamed_addr constant [2 x i8] c"b\00"
@.str.28 = private unnamed_addr constant [4 x i8] c"abc\00"
@.str.29 = private unnamed_addr constant [33 x i8] c"string_utils_test: insert failed\00"
@.str.30 = private unnamed_addr constant [14 x i8] c"string_test: \00"
@.str.31 = private unnamed_addr constant [6 x i8] c"hello\00"
@.str.32 = private unnamed_addr alias [6 x i8], [6 x i8]* bitcast (i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.37, i64 0, i64 6) to [6 x i8]*)
@.str.33 = private unnamed_addr constant [41 x i8] c"string_test: from_c_string length failed\00"
@.str.34 = private unnamed_addr constant [40 x i8] c"string_test: equal positive case failed\00"
@.str.35 = private unnamed_addr constant [40 x i8] c"string_test: equal negative case failed\00"
@.str.36 = private unnamed_addr alias [7 x i8], [7 x i8]* bitcast (i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.37, i64 0, i64 5) to [7 x i8]*)
@.str.37 = private unnamed_addr constant [12 x i8] c"hello world\00"
@.str.38 = private unnamed_addr constant [34 x i8] c"string_test: concat length failed\00"
@.str.39 = private unnamed_addr constant [35 x i8] c"string_test: concat content failed\00"
@.str.40 = private unnamed_addr constant [15 x i8] c"process_test: \00"
@.str.41 = private unnamed_addr constant [49 x i8] c"process_test: get_executable_path returned empty\00"
@.str.42 = private unnamed_addr constant [53 x i8] c"process_test: get_executable_env_path returned empty\00"
@.str.43 = private unnamed_addr constant [53 x i8] c"process_test: env path is not shorter than full path\00"
@.str.44 = private unnamed_addr constant [53 x i8] c"process_test: env path does not end with a backslash\00"
@.str.45 = private unnamed_addr constant [18 x i8] c"Executable Path: \00"
@.str.46 = private unnamed_addr constant [19 x i8] c"Environment Path: \00"
@.str.47 = private unnamed_addr constant [11 x i8] c"mem_test: \00"
@.str.48 = private unnamed_addr constant [24 x i8] c"mem_test: malloc failed\00"
@.str.49 = private unnamed_addr constant [35 x i8] c"mem_test: fill verification failed\00"
@.str.50 = private unnamed_addr constant [40 x i8] c"mem_test: zero_fill verification failed\00"
@.str.51 = private unnamed_addr constant [33 x i8] c"mem_test: malloc for copy failed\00"
@.str.52 = private unnamed_addr constant [35 x i8] c"mem_test: copy verification failed\00"
@.str.53 = private unnamed_addr constant [12 x i8] c"list_test: \00"
@.str.54 = private unnamed_addr constant [22 x i8] c"list_test: new failed\00"
@.str.55 = private unnamed_addr constant [41 x i8] c"list_test: length incorrect after extend\00"
@.str.56 = private unnamed_addr constant [33 x i8] c"list_test: walk length incorrect\00"
@.str.57 = private unnamed_addr constant [36 x i8] c"list_test: data mismatch for node 1\00"
@.str.58 = private unnamed_addr constant [36 x i8] c"list_test: data mismatch for node 2\00"
@.str.59 = private unnamed_addr constant [36 x i8] c"list_test: data mismatch for node 3\00"
@.str.60 = private unnamed_addr constant [33 x i8] c"list_test: foot pointer mismatch\00"
@.str.61 = private unnamed_addr constant [23 x i8] c"list_test: free failed\00"
@.str.62 = private unnamed_addr constant [45 x i8] c"D:\Projects\rcsharp\src_base_structs.rcsharp\00"
@.str.63 = private unnamed_addr constant [10 x i8] c"fs_test: \00"
@.str.64 = private unnamed_addr constant [47 x i8] c"The quick brown fox jumps over crazy lost dog.\00"
@.str.65 = private unnamed_addr constant [9 x i8] c"test.txt\00"
@.str.66 = private unnamed_addr constant [38 x i8] c"Filesystem test failed, data mismatch\00"
...
@.str.74 = private unnamed_addr constant [12 x i8] c"Exception: \00"
@.str.75 = private unnamed_addr constant [33 x i8] c"Failed to lock heap for walking.\00"
@.str.76 = private unnamed_addr constant [26 x i8] c"stdout handle was invalid\00"
...
entry:
	...
	call void @console.write(i8* @.str.5, i32 19)
...
then0:
	call void @console.write(i8* @.str.6, i32 2)
	br label %func_exit
endif0:
	store i64 %n, i64* %v1
	br label %loop_body1
...
entry:
	...
	%tmp73 = alloca i1
	%tmp78 = alloca i1
	call void @console.write(i8* @.str.7, i32 13)
...
then9:
	...
	br label %endif9
endif9:
	call void @"vector.push_bulk<i8>"(%"struct.vector.Vec<i8>"* %v0, i8* @.str.13, i32 2)
...
entry:
	...
	%v0 = alloca i32; var: i
	%tmp24 = alloca i1
	call void @console.write(i8* @.str.18, i32 19)
	%tmp0 = call i32 @string_utils.c_str_len(i8* @.str.19)
...
then0:
	...
	br label %endif0
endif0:
	%tmp2 = call i32 @string_utils.c_str_len(i8* @.str.21)
	%tmp3 = icmp ne i32 %tmp2, 0
	br i1 %tmp3, label %then1, label %endif1
then1:
...
logic_rhs_2:
	%tmp7 = call i1 @char_utils.is_digit(i8 98)
...
then3:
	...
	br label %endif3
endif3:
	%tmp9 = call i1 @char_utils.is_alpha(i8 97)
	%tmp10 = xor i1 1, %tmp9
	store i1 %tmp10, i1* %tmp11
	br i1 %tmp10, label %logic_end_4, label %logic_rhs_4
logic_rhs_4:
	%tmp12 = call i1 @char_utils.is_alpha(i8 57)
...
then7:
	...
	br label %endif7
endif7:
	%tmp19 = call i8* @string_utils.insert(i8* @.str.26, i8* @.str.27, i32 1)
	store i32 0, i32* %v0
	br label %loop_body8
loop_body8:
...
logic_rhs_9:
	...
	%tmp26 = getelementptr inbounds i8, i8* @.str.28, i32 %tmp25
...
endif10:
	...
	%tmp34 = getelementptr inbounds i8, i8* @.str.28, i32 %tmp33
...
entry:
	...
	call void @console.write(i8* @.str.30, i32 13)
	%tmp0 = call %struct.string.String @string.from_c_string(i8* @.str.31)
	store %struct.string.String %tmp0, %struct.string.String* %v0
	%tmp1 = call %struct.string.String @string.from_c_string(i8* @.str.31)
	store %struct.string.String %tmp1, %struct.string.String* %v1
	%tmp2 = call %struct.string.String @string.from_c_string(i8* @.str.32)
...
then2:
	...
	br label %endif2
endif2:
	%tmp9 = call %struct.string.String @string.concat_with_c_string(%struct.string.String* %v0, i8* @.str.36)
	store %struct.string.String %tmp9, %struct.string.String* %v3
	%tmp10 = call %struct.string.String @string.from_c_string(i8* @.str.37)
...
entry:
	...
	call void @console.write(i8* @.str.40, i32 14)
...
then3:
	...
	br label %endif3
endif3:
	call void @console.write(i8* @.str.45, i32 17)
	...
	call void @console.write(i8* @.str.46, i32 18)
...
entry:
	%v0 = alloca i64; var: i
	%v1 = alloca i64; var: i
	call void @console.write(i8* @.str.47, i32 10)
...
entry:
	...
	%tmp41 = alloca i1
	call void @console.write(i8* @.str.53, i32 11)
...
entry:
	...
	%tmp0 = call i32 @fs.create_file(i8* @.str.62)
	%tmp1 = icmp eq i32 %tmp0, 1
	br i1 %tmp1, label %then0, label %endif0
then0:
	call i32 @fs.delete_file(i8* @.str.62)
	br label %func_exit
endif0:
	%tmp2 = call %struct.string.String @fs.read_full_file_as_string(i8* @.str.62)
...
endif10:
	%tmp74 = load i8, i8* %v2
	%tmp75 = call i1 @char_utils.is_alpha(i8 %tmp74)
...
entry:
	...
	call void @console.write(i8* @.str.63, i32 9)
	%tmp0 = call %struct.string.String @string.from_c_string(i8* @.str.64)
	store %struct.string.String %tmp0, %struct.string.String* %v0
	%tmp1 = call %struct.string.String @process.get_executable_env_path()
	store %struct.string.String %tmp1, %struct.string.String* %v1
	%tmp2 = call %struct.string.String @string.concat_with_c_string(%struct.string.String* %v1, i8* @.str.65)
	store %struct.string.String %tmp2, %struct.string.String* %v2
...
entry:
	call void @console.writeln(i8* @.str.67, i32 14)
	call void @console.writeln(i8* @.str.68, i32 25)
	call void @console.write(i8* @.str.69, i32 21)
	call void @console.println_i64(i64 12345)
	call void @console.write(i8* @.str.70, i32 22)
	call void @console.println_i64(i64 -67890)
	call void @console.write(i8* @.str.71, i32 17)
	call void @console.println_i64(i64 0)
	call void @console.write(i8* @.str.72, i32 26)
	call void @console.println_u64(i64 9876543210)
	call void @console.writeln(i8* @.str.73, i32 23)
	call void @console.writeln(i8* @.str.17, i32 2)
	br label %func_exit
func_exit:
	ret void
...
entry:
	...
	call void @console.writeln(i8* @.str.74, i32 11)
...
logic_rhs_0:
	%tmp2 = call i1 @char_utils.is_digit(i8 %c)
...
entry:
	...
	br i1 %tmp0, label %logic_end_0, label %logic_rhs_0
logic_rhs_0:
	%tmp2 = call i1 @char_utils.is_xdigit(i8 %c)
	store i1 %tmp2, i1* %tmp1
	br label %logic_end_0
logic_end_0:
	%tmp3 = load i1, i1* %tmp1
...
logic_end_0:
	...
	br i1 %tmp3, label %logic_end_1, label %logic_rhs_1
logic_rhs_1:
	%tmp5 = icmp sge i8 %c, 65
	store i1 %tmp5, i1* %tmp6
	br i1 %tmp5, label %logic_rhs_2, label %logic_end_2
logic_rhs_2:
	%tmp7 = icmp sle i8 %c, 90
	store i1 %tmp7, i1* %tmp6
	br label %logic_end_2
logic_end_2:
	%tmp8 = load i1, i1* %tmp6
