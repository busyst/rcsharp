...
%struct.EnumSymbolTableEntry = type { %struct.CompilerType, %struct.vector.Vec_%struct.EnumDefinedField_, i8 }
%struct.StructDefinedField = type { void, %struct.CompilerType }
%struct.StructSymbolTableEntry = type { %struct.vector.Vec_%struct.StructDefinedField_, %struct.Layout, %struct.string.String, i8 }
%struct.FunctionSymbolTableEntry = type { %struct.vector.Vec_%struct.StructDefinedField_, %struct.CompilerType, %struct.vector.Vec_%struct.Stmt_, i8 }
%struct.GenericFunctionSymbolTableEntry = type { %struct.vector.Vec_%struct.GenericStructDefinedField_, i1, %struct.CompilerType, %struct.vector.Vec_%struct.Stmt_, %struct.vector.Vec_void_, %struct.vector.Vec_%struct.vector.Vec_%struct.CompilerType__, i8 }
%struct.GenericStructDefinedField = type { void, %struct.CompilerType, i1 }
%struct.GenericStructSymbolTableEntry = type { %struct.vector.Vec_%struct.GenericStructDefinedField_, %struct.vector.Vec_void_, %struct.vector.Vec_%struct.vector.Vec_%struct.CompilerType__, %struct.string.String, i8 }
...
%struct.SymbolTable = type { %struct.vector.Vec_%struct.SymbolTableEntry_, %struct.vector.Vec_%struct.string.String_* }
%struct.Variable = type { i16 }
%struct.Scope = type { %struct.vector.Vec_%struct.Variable_, %struct.vector.Vec_i16_ }
...
%struct.NameWithGenericsExpr = type { %struct.Expression, %struct.vector.Vec_%struct.Type_ }
%struct.CallExpr = type { %struct.Expression, %struct.vector.Vec_%struct.Expression_, %struct.vector.Vec_%struct.Type_ }
%struct.RangeExpr = type { %struct.Expression, %struct.Expression, i1 }
%struct.IndexExpr = type { %struct.Expression, %struct.Expression }
%struct.ArrayExpr = type { %struct.vector.Vec_%struct.Expression_ }
%struct.StructInitFieldExpr = type { void, %struct.Expression }
%struct.StructInitExpr = type { %struct.Expression, %struct.vector.Vec_%struct.StructInitFieldExpr_ }
...
%struct.FunctionType = type { %struct.vector.Vec_%struct.Type_, %struct.Type }
%struct.NamespaceLinkType = type { %struct.Path, %struct.Type }
%struct.GenericType = type { void, %struct.vector.Vec_%struct.Type_ }
...
%struct.HintNode = type { void, %struct.vector.Vec_%struct.Expression_ }
%struct.FnNode = type { void, i8, %struct.vector.Vec_%struct.Argument_, i1, %struct.Type, %struct.vector.Vec_void_, %struct.vector.Vec_%struct.Stmt_ }
%struct.EnumNode = type { void, i8, i1, %struct.Type, %struct.vector.Vec_%struct.EnumField_ }
%struct.StructNode = type { void, i8, %struct.vector.Vec_%struct.Argument_, %struct.vector.Vec_void_ }
%struct.IfStmt = type { %struct.Expression, %struct.vector.Vec_%struct.Stmt_, %struct.vector.Vec_%struct.Stmt_ }
%struct.LoopStmt = type { %struct.vector.Vec_%struct.Stmt_ }
%struct.WhileStmt = type { %struct.Expression, %struct.vector.Vec_%struct.Stmt_ }
%struct.DoWhileStmt = type { %struct.Expression, %struct.vector.Vec_%struct.Stmt_ }
%struct.ForStmt = type { %struct.Expression, %struct.Expression, %struct.vector.Vec_%struct.Stmt_ }
%struct.NamespaceNode = type { void, %struct.vector.Vec_%struct.Stmt_ }
%struct.BlockStmt = type { %struct.vector.Vec_%struct.Stmt_ }
